...
const icons: { [key: string]: (size: number) => JSX.Element } = {
  dashboard: (size) => (
  ...
  // ... add all other icons here following the same pattern
  // I'm truncating for brevity, but include all icons from your original code
};

export const IconComponent: React.FC<IconProps> = ({ name, size = 16 }) => {
