                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        ...
                        className={({ isActive }) => `group relative flex items-center mb-4 gap-5 rounded-sm py-2 px-4 font-medium !text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4` + (isActive && '!text-[#0065DE] bg-white text-primary py-3 px-1 text-[16px]')}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <svg className='fill-current' width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-5 pl-3">
                          ...
                          <li>
                            <SidebarLinkGroup
                              activeCondition={
                                pathname === '/inspection' || pathname.includes('inspection')
                              }
                            >
                              {(handleClick, open) => {
                                return (
                          ...
                          <li>
                            <SidebarLinkGroup
                              activeCondition={
                                pathname === '/spb' || pathname.includes('spb')
                              }
                            >
                              {(handleClick, open) => {
                                return (
                                  <React.Fragment>
                                    <NavLink
                                      to="/maintenance/spb"
                                      className={`group relative flex items-center gap-5 mb-2 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out  ${(pathname === '/maintenance/spb' ||
                                        pathname.includes('/maintenance/spb')) &&
                                        ' dark:bg-meta-4'
                                        }`}
                                      onClick={(e) => {
                                        e.preventDefault();
                          ...
                          <li>
                            <SidebarLinkGroup
                              activeCondition={
                                pathname === '/maintenance/sparepart' || pathname.includes('/maintenance/sparepart')
                              }
                            >
                              {(handleClick, open) => {
                                return (
                                    ...
                                    >
                                      <ul className=" flex flex-col gap-5  md:pl-5 pl-6 py-3">
                                        <li>
                                          <SidebarLinkGroup
                                            activeCondition={
                                              pathname === '/maintenance/sparepart' || pathname.includes('maintenance')
                                            }
                                          >
                                            {(handleClick, open) => {
                                              return (
                                                <React.Fragment>
                                                  <NavLink
                                                    ...
                                                    className={({ isActive }) => `group relative flex items-center gap-5 mb-2 rounded-sm py-2 px-1 font-medium text-bodydark1 duration-300 ease-in-out ` +
                                                      (isActive && '!text-[#0065DE] bg-white py-3 px-1 text-[16px]')}
                                                    onClick={(e) => {
                                                      e.preventDefault();
                                                      sidebarExpanded
