...
function MasterPerusahaanIsi() {
  ...
  async function getPerusahaan() {
    const url = `${import.meta.env.VITE_API_LINK}/master/perusahaan`;
    try {
      setIsLoading(true);
              ...
              <>
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    className="border-2 border-stroke px-2 py-1 rounded-md"
                  ...
                  <input
                    ...
                    className="border-2 border-stroke px-2 py-1 rounded-md"
                    defaultValue={perusahaan?.kelurahan}
                  />
                  ...
                  <input
                    ...
                    className="border-2 border-stroke px-2 py-1 rounded-md"
                    defaultValue={perusahaan?.kecamatan}
                  />
                  ...
                  <input
                    ...
                    className="border-2 border-stroke px-2 py-1 rounded-md"
                    defaultValue={perusahaan?.kode_pos}
                  />
                  ...
                  <input
                    ...
                    className="border-2 border-stroke px-2 py-1 rounded-md"
                    defaultValue={perusahaan?.negara}
                  />
                  ...
                  <input
                    ...
                    className="border-2 border-stroke px-2 py-1 rounded-md"
                    defaultValue={perusahaan?.no_tlp}
                  />
