...
function MasterShiftHRD() {
  ...
  async function hapusJam(id: any) {
    if (
      window.confirm('Apakah Anda yakin ingin Menghapus Jam Istirahat ini?')
    ) {
      const url = `${
                                  ...
                                  <div className="flex w-full flex-col">
                                    ...
                                    <div className="flex w-full">
                                      <input
                                        ...
                                        onChange={(e) => {
                                          setShift1MasukEdit(e.target.value);
                                        }}
                                        type="time"
                                        className=" w-[387px] h-10 border-2 border-stroke rounded-md"
                                      />
                                  ...
                                  <div className="flex w-full flex-col">
                                    ...
                                    <div className="flex w-full">
                                      <input
                                        ...
                                        onChange={(e) => {
                                          setShift1KeluarEdit(e.target.value);
                                        }}
                                        type="time"
                                        className=" w-[387px] h-10 border-2 border-stroke rounded-md"
                                      />
                                  ...
                                  <div className="flex w-full flex-col">
                                    ...
                                    <div className="flex w-full">
                                      <input
                                        ...
                                        onChange={(e) => {
                                          setShift2MasukEdit(e.target.value);
                                        }}
                                        type="time"
                                        className=" w-[387px] h-10 border-2 border-stroke rounded-md"
                                      />
                                  ...
                                  <div className="flex w-full flex-col">
                                    ...
                                    <div className="flex w-full">
                                      <input
                                        ...
                                        onChange={(e) => {
                                          setShift2KeluarEdit(e.target.value);
                                        }}
                                        type="time"
                                        className=" w-[387px] h-10 border-2 border-stroke rounded-md"
                                      />
