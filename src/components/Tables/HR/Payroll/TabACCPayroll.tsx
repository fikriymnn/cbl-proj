...
export default function TabAccPayroll() {
      ...
      >
        <AppBar position="static" className="">
          <ThemeProvider theme={theme}>
            ...
            >
              <Tab label="Incoming Payroll Mingguan" {...a11yProps(0)} />
              <Tab label="Incoming Payroll Bulanan" {...a11yProps(1)} />
            </Tabs>
          </ThemeProvider>
        </AppBar>
