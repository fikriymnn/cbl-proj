                                                ...
                                                <>
                                                    ...
                                                    {filteredData.map((data2: any, ii: number) => (
                                                        <div
                                                            ...
                                                            <label className="text-neutral-500 text-xs font-semibold  ">
                                                                {data2.karyawan?.biodata_karyawan[0]?.department?.nama_department}
                                                            </label>
                                                                            ...
                                                                            <div className='grid grid-cols-2 gap-2 px-4 py-4'>
                                                                                ...
                                                                                <div className='flex flex-col gap-2'>
                                                                                    <div className='flex flex-col'>
                                                                                        ...
                                                                                        <label htmlFor="" className='text-[#7a7a7a] text-xl font-normal'>
                                                                                            {convertTimeStampToDate(data2.periode_dari)}
                                                                                        </label>
                                                                                        <label htmlFor="" className='text-[#7a7a7a] text-xl font-normal'>
                                                                                            ~ {convertTimeStampToDate(data2.periode_sampai)}
                                                                                        </label>
                                                                                    </div>
                                                                                    <div className='flex flex-col'>
                                                                                    ...
                                                                                    {data2.detail_payroll?.filter((data3: any) => data3.tipe === 'bayaran').map((data3: any, iii: any) => (
                                                                                        <div
                                                                                            ...
                                                                                            <div className='flex gap-3 col-span-3'>
                                                                                                ...
                                                                                                <label className="text-neutral-500 text-xs font-semibold ">
                                                                                                    {data3.label} =  {data3.jumlah} x {data3.nilai}
                                                                                                </label>
                                                                                            </div>
