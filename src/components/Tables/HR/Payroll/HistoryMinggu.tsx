...
import EnhancedEmployeeFilter from './EnhancedEmployeeFilter';
import EnhancedEmployeeFilterMinggu from './EchancedEmployeeFIlterMinggu';
                  ...
                  {showEdit[i] == true && (
                    ...
                    >
                      <>
                        ...
                        />
                        <div className="grid grid-cols-6 gap-4 px-3 py-4 border-b-8 border-[#D8EAFF] ">
                        ...
                        {filteredData.map((data2: any, ii: number) => (
                          <div
                            key={ii}
                            className="grid grid-cols-6 gap-4 px-3 py-4 border-b-8 border-[#D8EAFF] "
                          >
                            <div className="flex gap-3">
                              <label className="text-black text-xs font-bold">
                                {ii + 1}
                            ...
                            <label className="text-neutral-500 text-xs font-semibold  ">
                              {
                                data2.karyawan?.biodata_karyawan[0]?.divisi
                                  ?.nama_divisi
                              }
                            </label>
                            <label className="text-neutral-500 text-xs font-semibold ">
