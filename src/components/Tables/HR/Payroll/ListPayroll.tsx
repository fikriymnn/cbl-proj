...
function ListPayroll() {
  ...
  async function getPayrollMingguan(
    dateFrom1: any,
    dateTo1: any,
    id_karyawan: any,
  ) {
                        ...
                        <>
                          <>
                            ...
                            <div className="flex flex-col gap-1 py-4 max-h-[500px] overflow-y-scroll ">
                              {payWeek != null &&
                                payWeek?.data?.detailAbsensi?.map(
                                  (data2: any, ii: any) => (
                                    <>
                                      <div
                                        key={ii}
                                      ...
                                      >
                                        ...
                                        <p className="text-sm text-neutral-500 col-span-2">
                                          {data2.payroll?.total == null ||
                                          data2.payroll?.total == 0
                                            ? '-'
                                            : formatCurrency(
                                                data2.payroll?.total,
                                              )}
                              ...
                              <div className="grid grid-cols-2 items-center py-2  border-b-8 border-[#D8EAFF]">
                                <div className="flex flex-col ">
                                  <div className="flex">
                                    <p>Rincian :</p>
                                    <div>
                                      {payWeek?.data?.summaryPayroll?.rincian?.map(
                                        (
                                          dataRincian: any,
                                          iRincian: number,
                                        ) => {
                                  ...
                                  {payWeek?.data?.summaryPayroll
                                    ?.upahHarianSakit.length != 0 ? (
                                    <div className="flex">
                                      <p>Upah Harian Sakit :</p>
                                      <div>
                                        {payWeek?.data?.summaryPayroll?.upahHarianSakit?.map(
                                  ...
                                  <div>
                                    ...
                                    {payWeek?.data?.summaryPayroll?.potongan
                                      .length != 0
                                      ? payWeek?.data?.summaryPayroll?.potongan.map(
                                          (data3: any) => (
                                ...
                                <div className="flex flex-col justify-end w-full">
                                  <div>
                                    {`Total Upah : Rp.  ${
                                      payWeek?.data?.summaryPayroll?.total +
                                      parseInt(insentif)
                                    }`}
                                  </div>
                                </div>
