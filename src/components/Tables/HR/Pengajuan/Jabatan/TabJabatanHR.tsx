...
import IncomingStatusKaryawan from './PromosiStatusKaryawan/IncomingStatusKaryawan';
import IncomingPromosi from './Promosi/IncomingPromosi';
...
export default function TabJabatanHR() {
