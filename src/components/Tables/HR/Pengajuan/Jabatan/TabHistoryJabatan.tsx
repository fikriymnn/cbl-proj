...
import HistoryStatusKaryawan from './PromosiStatusKaryawan/HistoryStatusKaryawan';
import DiprosesPromosi from './Promosi/DiprosesPromosi';
...
export default function TabHistoryJabatan() {
