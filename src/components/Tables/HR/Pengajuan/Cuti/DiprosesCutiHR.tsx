...
function DiProsesCutiHR() {
  ...
  async function hapusCuti(id: any, dari: any, sampai: any, name: any) {
    if (
      window.confirm(
        `Apakah Anda yakin ingin Membatalkan Cuti Untuk Karyawan  ${name} pada tanggal ${dari} - ${sampai}   ?`,
      )
    ) {
      const url = `${
              ...
              return (
                <>
                  <div className="grid grid-cols-12 border-b-8 border-[#D8EAFF] gap-2 items-center px-10">
                    ...
                    <label className="text-neutral-500 text-sm font-semibold uppercase col-span-2"></label>
                    <div className="justify-end flex flex-col pr-2 ">
                      <>
                        <button
                        ...
                        <button
                          ...
                          className={`uppercase px-5 inline-flex rounded-[3px] items-center text-white text-xs font-bold  py-2 my-2   hover:bg-red-400 border bg-red-600 border-red-600  justify-center`} // Dynamic class assignment
                        >
                          Batalkan
                        </button>
                        {showModal[i] == true && (
