...
function DiprosesSakitHR() {
  ...
  async function hapusCuti(id: any, dari: any, sampai: any, name: any) {
    if (
      window.confirm(
        `Apakah Anda yakin ingin Membatalkan Pengajuan Sakit Untuk Karyawan  ${name} pada tanggal ${dari} - ${sampai}   ?`,
      )
    ) {
      const url = `${
            ...
            {sakit?.data?.map((data: any, i: any) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="justify-end flex flex-col pr-2 col-span-1">
                    <button
