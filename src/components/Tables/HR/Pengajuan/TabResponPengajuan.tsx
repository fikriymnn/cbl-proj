        ...
        <AppBar position="static" className="">
          <ThemeProvider theme={theme}>
            ...
            >
              <Tab
                label={`Lembur ${
                  task?.pengajuan_lembur == 0
                    ? ''
                    : '(' + task?.pengajuan_lembur + ')'
                }`}
                {...a11yProps(0)}
              />
              <Tab
                label={`Cuti ${
                  task?.pengajuan_cuti == 0
                    ? ''
                    : '(' + task?.pengajuan_cuti + ')'
                }`}
                {...a11yProps(1)}
              ...
              <Tab
                label={`Sakit ${
                  task?.pengajuan_sakit == 0
                    ? ''
                    : '(' + task?.pengajuan_sakit + ')'
                }`}
                {...a11yProps(3)}
              />
              <Tab
                label={`Mangkir ${
                  task?.pengajuan_mangkir == 0
                    ? ''
                    : '(' + task?.pengajuan_mangkir + ')'
                }`}
                {...a11yProps(4)}
              />
              <Tab
                label={`Pinjaman ${
                  task?.pengajuan_pinjaman == 0
                    ? ''
                    : '(' + task?.pengajuan_pinjaman + ')'
                }`}
                {...a11yProps(5)}
              />
              <Tab
