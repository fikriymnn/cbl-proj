...
function NcrDibuatHR() {
  ...
  return (
    <>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex flex-col w-full ">
                        <div className="w-full">
                          <div className=" text-black text-xs font-bold">
                            ISI LAPORAN KETIDAK SESUAIAN
                          </div>
                        </div>

                        <div className=" w-full pt-4 ">
                          <div className=" text-[#646464]   flex flex-col gap-1">
                            <p className="font-bold">KATEGORI LAPORAN</p>
                          ...
                          <>
                            <div className=" flex flex-col w-full gap-1">
                              <div className="flex flex-col w-full">
                                ...
                                <p className="font-bold pt-2">No. Io</p>
                                <input
                                  onChange={(e) => setNoIO(e.target.value)}
                                  type="text"
                                  placeholder="Nomor IO"
                                  className="bg-white border border-stroke rounded-md h-7 pl-4"
                                ></input>

                                <p className="font-bold pt-2">PRODUK</p>
                                <input
                      ...
                      <div className="flex flex-col">
                        ...
                        {ncr.map((data: any, i: number) => {
                          const formattedOptions = department?.map(
                            (item: any) => ({
      ...
      {ncrMTC?.map((data: any, iii: number) => {
        return (
          <>
