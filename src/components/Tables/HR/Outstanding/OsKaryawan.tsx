                        ...
                        >
                          <>
                            <div className="grid grid-cols-1 gap-1 px-7 py-4">
                              ...
                              <p className="text-black text-medium">
                                Lakukan analisa untuk kerja karyawan dengan
                                hati-hati, pelajari faktor dan masing masing
                                tingkat penilaian.
                              </p>
                              ...
                              <div className="grid grid-cols-10 w-full">
                                ...
                                <div className="col-span-4 flex gap-2">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setjumlahTanpaKeterangan(e.target.value)
                                    }
                                    className="border-2 border-stroke px-2 "
                                    type="text"
                                    placeholder="Masukkan Hari"
                              ...
                              <div className="grid grid-cols-10 w-full">
                                ...
                                <div className="col-span-4 flex gap-2">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setjumlahKeterlambatan(e.target.value)
                                    }
                                    className="border-2 border-stroke px-2 "
                                    type="text"
                                    placeholder="Masukkan Hari"
                              ...
                              <div className="grid grid-cols-8 w-full">
                                ...
                                <div className="col-span-4 flex gap-2">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setperingatanKe1(e.target.value)
                                    }
                                    className="border-2 border-stroke px-2 "
                                    type="text"
                              ...
                              <div className="grid grid-cols-8 w-full">
                                ...
                                <div className="col-span-4 flex gap-2">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setperingatanKe2(e.target.value)
                                    }
                                    className="border-2 border-stroke px-2 "
                                    type="text"
                              ...
                              <div className="grid grid-cols-8 w-full">
                                ...
                                <div className="col-span-4 flex gap-2">
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setperingatanKe3(e.target.value)
                                    }
                                    className="border-2 border-stroke px-2 "
                                    type="text"
                              ...
                              <textarea
                                onChange={(e) =>
                                  setkesanPenilai(e.target.value)
                                }
