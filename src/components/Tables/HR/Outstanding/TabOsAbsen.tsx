...
export default function TabOsAbsen({ data }: { data: any }) {
    ...
    const [tglDari, setTglDari] = useState<any>(data.tanggal);
    const [alasanCuti, setAlasanCuti] = useState<any>();

    const handleStartDateChange = () => {
        setTglDari(new Date(data.tanggal));
    };
                    ...
                    <main className="overflow-x-scroll px-2 py-2">
                        ...
                        <div className=" bg-white">
                            ...
                            <div className='flex w-full justify-end items-end px-7 py-4'>
                                ...
                                <button
                                    onClick={() => postIzin(data.tanggal, data.id_karyawan)}
                                    disabled={isLoading}
                        ...
                        <div className=" bg-white">
                            ...
                            <div className='grid grid-cols-2 gap-5 px-7 py-4'>
                                ...
                                <div className='flex w-full flex-col px-7 py-4'>
                                    ...
                                    <button
                                        onClick={() => postCutiKhusus(data.tanggal, data.id_karyawan)}
                                        disabled={isLoading}
                                        className='flex px-4 py-1 justify-center items-center bg-blue-600 text-white font-semibold rounded-md'
                                    >
                                        AJUKAN
                    ...
                    <main className="overflow-x-scroll px-2 py-2">
                        ...
                        <div className=" bg-white">
                            ...
                            <div className='flex w-full justify-end items-end px-7 py-4'>
                                ...
                                <button
                                    onClick={() => postMangkir(data.tanggal, data.id_karyawan)}
                                    disabled={isLoading}
                                    className='flex px-4 py-1 justify-center items-center bg-blue-600 text-white font-semibold rounded-md'
                                >
                                    AJUKAN
