            ...
            <div className="">
              ...
              {showTable4 && (
                <div className="overflow-x-auto mt-4">
                  <table className="min-w-full border-collapse border border-gray-300">
                    <tbody>
                      {karyawan?.rekap?.jenis_kelamin?.map(
                        (dept: any, deptIndex: any) => {
                          ...
                          const normalizedKelaminName = kelaminName
                            .replace(/\s+/g, '')
                            .toLowerCase();

                          // Filter employees that belong to this jenis kelamin with normalized comparison
                          const filteredEmployees = karyawan?.data?.filter(
                            (employee: any) => {
                              const employeeKelamin =
                              ...
                              return (
                                normalizedEmployeeKelamin ===
                                normalizedKelaminName
                              );
                            },
                          );
            ...
            <div className="">
              ...
              {showTable5 && (
                <div className="overflow-x-auto mt-4">
                  <table className="min-w-full border-collapse border border-gray-300">
                    <tbody>
                      {karyawan?.rekap?.status_karyawan?.map(
                        (dept: any, deptIndex: any, index: any) => {
                          // Get the department name from rekap
                          const departmentName = dept.nama;
                          ...
                          return departmentEmployees &&
                            ...
                            >
                              <h3 className="text-lg font-semibold mb-2">
                                Status Karyawan : {departmentName}
                              </h3>
                              <table className="min-w-full border-collapse border border-gray-300">
                                <thead>
                                  <tr className="bg-gray-100">
            ...
            <div className="">
              ...
              {showTable6 && (
                <div className="overflow-x-auto mt-4">
                  <table className="min-w-full border-collapse border border-gray-300">
                    <tbody>
                      {karyawan?.rekap?.tipe_karyawan?.map(
                        (dept: any, deptIndex: any, index: any) => {
                          // Get the department name from rekap
                          const departmentName = dept.nama;
                          ...
                          const departmentEmployees = karyawan?.data?.filter(
                            (employee: any) => {
                              ...
                              if (!employeeType || !departmentName)
                                return false;
            ...
            <div className="">
              ...
              {showTable7 && (
                <div className="overflow-x-auto mt-4">
                  <table className="min-w-full border-collapse border border-gray-300">
                    <tbody>
                      {karyawan?.rekap?.tipe_penggajian?.map(
                        (dept: any, deptIndex: any, index: any) => {
                          // Get the department name from rekap
                          const departmentName = dept.nama;
                          ...
                          return departmentEmployees &&
                            ...
                            >
                              <h3 className="text-lg font-semibold mb-2">
                                Tipe Penggajian : {departmentName}
                              </h3>
                              <table className="min-w-full border-collapse border border-gray-300">
                                <thead>
                                  <tr className="bg-gray-100">
