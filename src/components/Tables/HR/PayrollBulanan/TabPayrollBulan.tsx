...
import PayrollBulan from './PayrollBulan';
import PengajuanPayrollBulan from './PengajuanPayrollBulan';
import HistoryBulan from './HistoryPayrollBulan';
...
export default function TabPayrollBulan() {
            ...
            >
                <AppBar position="static" className="">
                    <ThemeProvider theme={theme}>
                        ...
                        >
                            <Tab label="Payroll Bulanan" {...a11yProps(0)} />
                            <Tab label="Pengajuan Payroll Bulanan" {...a11yProps(1)} />
                            {/* <Tab label="Payroll Bulanan" {...a11yProps(2)} /> */}
                            <Tab label="History Payroll Bulanan" {...a11yProps(2)} />
