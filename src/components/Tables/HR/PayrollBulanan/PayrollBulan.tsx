...
import EmployeeFilter from '../Payroll/EmployeeFilter';
...
function PayrollBulan() {
  ...
  async function getPayrollMingguan(dateFrom1: any, dateTo1: any) {
    const url = `${import.meta.env.VITE_API_LINK}/hr/payrollBulananAll`;
    try {
      setIsLoading(true);
                                ...
                                (data2: any, ii: any) => (
                                  <>
                                    <div className="grid grid-cols-12  py-4 border-b-8 border-[#D8EAFF] gap-2 ">
                                      ...
                                      <label className="text-neutral-500 text-sm font-semibold flex gap-1">
                                        {data2.shift == null || data2.shift == 0
                                          ? ' ~'
                                          : data2.shift}
                                      </label>
                                      <label className="text-neutral-500 text-sm font-semibold">
                                      ...
                                      <div className="flex flex-col gap-1 col-span-2">
                                        ...
                                        <label className="text-neutral-500 text-sm font-semibold ">
                                          {data2.menit_terlambat == null ||
                                          data2.menit_terlambat == 0
                                            ? '~'
                                            : '~ ' +
                                              data2.menit_terlambat +
                                              ' Jam'}
                                        </label>
                                      </div>
                                      <label className="text-neutral-500 text-sm font-semibold ">
