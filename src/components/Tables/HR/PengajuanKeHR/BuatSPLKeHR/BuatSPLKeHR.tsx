        ...
        <div className="flex w-full justify-end items-center gap-4 px-8 py-6 bg-gray-50 border-t border-gray-200">
          {isEditMode && (
            <button
              ...
              disabled={isLoading}
              className="flex px-8 py-3 justify-center items-center gap-3 bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 disabled:from-gray-400 disabled:to-gray-500 shadow-lg hover:shadow-xl text-white font-bold rounded-lg transition-all duration-200 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed"
            >
