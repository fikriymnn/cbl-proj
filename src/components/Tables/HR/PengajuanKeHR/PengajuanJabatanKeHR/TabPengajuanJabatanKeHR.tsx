...
import BuatStatusKaryawan from './StatusKaryawan/BuatStatusKaryawan';
import BuatPromosiHR from './Promosi/BuatPromosiHR';
...
export default function TabPengajuanJabatanKeHR() {
