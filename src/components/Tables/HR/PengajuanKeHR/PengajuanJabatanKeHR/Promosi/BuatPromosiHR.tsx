        ...
        <main className="overflow-x-scroll min-h-screen">
            ...
            <div className="min-w-[700px] bg-white rounded-xl ">
                <div className='grid grid-cols-2 gap-5  border-b-8 border-[#D8EAFF] px-7 py-4 '>
                    ...
                    <div className='flex flex-col gap-1'>
                        <label className='text-[#6c6b6b] text-sm font-semibold'>Jenis Pengajuan</label>
                        <Select
                            options={[
                            ...
                            <table className="w-full border-collapse border border-blue-600 bg-white shadow-lg rounded-lg">
                                ...
                                <tbody>
                                    <tr className="text-center hover:bg-blue-100 transition">
                                        <td className="p-3 border border-blue-300">{selectedEmployee.biodata_karyawan[0]?.nik}</td>
                                        <td className="p-3 border border-blue-300">{selectedEmployee.name}</td>
                                        <td className="p-3 border border-blue-300">{selectedEmployee.biodata_karyawan[0]?.jabatan?.nama_jabatan}</td>
                                        <td className="p-3 border border-blue-300">{selectedEmployee.biodata_karyawan[0]?.status?.nama_status}</td>
                                        <td className="p-3 border border-blue-300">{selectedEmployee.biodata_karyawan[0]?.department?.nama_department}</td>
                                        <td className="p-3 border border-blue-300">{selectedEmployee.biodata_karyawan[0]?.divisi?.nama_divisi}</td>
                                        <td className="p-3 border border-blue-300">{selectedEmployee.biodata_karyawan[0]?.grade?.kategori}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div className='grid grid-cols-2 gap-5 px-7 py-4'>
                    ...
                    {type === "mutasi" && (
                        ...
                        <div className='flex flex-col gap-1'>
                            <label className='text-[#6c6b6b] text-sm font-semibold'>Department Tujuan</label>
                            <Select
                                options={optionsDept}
                    ...
                    <div className="flex w-full flex-col">
                        <label className="text-[#6c6b6b] text-sm font-semibold">
                            {type === "promosi" ? "Alasan Promosi" : type === "demosi" ? "Alasan Demosi" : "Alasan Mutasi"}
                        </label>
