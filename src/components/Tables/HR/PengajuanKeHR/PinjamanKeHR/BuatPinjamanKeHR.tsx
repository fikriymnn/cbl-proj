                    ...
                    <div className='flex flex-col gap-3'>
                        <div className='flex flex-col w-full'>
                            ...
                            <input
                                ...
                                type="number" className='border-2 border-stroke rounded md' />
                        </div>
                                ...
                                {tipeCicilan == 'bulanan' ? (
                                    <>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setTempoCicilan(parseFloat(e.target.value))}
                                            type="number" className='border-2 border-stroke rounded md' />
                                    </>
                                ) : (
                                    <>
                        ...
                        <div className='flex flex-col w-full'>
                            ...
                            <input
                                ...
                                type="text" className='border-2 border-stroke rounded md' />
                        </div>
