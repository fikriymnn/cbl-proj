...
import HistoryBuatStatusKaryawanAll from './StatusKaryawan/HistoryBuatStatusKaryawan';
import HistoryPromosiHRAll from './Promosi/HistoryBuatPromosiHR';
...
export default function TabHistoryPengajuanJabatanKeHRAll() {
        ...
        <AppBar position="static" className="">
          <ThemeProvider theme={theme}>
            ...
            >
              ...
              <Tab label="Promosi / Demosi / Mutasi" {...a11yProps(1)} />
