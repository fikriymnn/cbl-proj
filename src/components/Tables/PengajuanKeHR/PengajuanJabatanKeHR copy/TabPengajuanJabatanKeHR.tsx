...
import BuatStatusKaryawanAll from './StatusKaryawan/BuatStatusKaryawan';
import BuatPromosiHRAll from './Promosi/BuatPromosiHR';
...
export default function TabPengajuanJabatanKeHRAll() {
