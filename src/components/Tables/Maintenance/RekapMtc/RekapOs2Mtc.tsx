  ...
  return (
    <div>
        ...
        <div className="md:grid grid-cols-1 gap-5 px-10 pb-10 pt-5">
          ...
          <div className="flex flex-col">
            <div className="grid grid-cols-11 border-2 border-black px-1 justify-center gap-4 bg-slate-300">
              ...
              <label className="text-sm font-semibold col-span-2">Mesin</label>
              ...
              return (
                <>
                  <div className="grid grid-cols-11 border-x-2 py-1 px-2  border-b-2 border-black  justify-center gap-4">
                    ...
                    <label className="text-sm col-span-2">{data.mesin}</label>
                    <label className="text-sm col-span-2">{data.count}</label>
            ...
            <div className="grid grid-cols-11 border-2 border-black px-1 justify-center gap-4 bg-slate-300">
              <label className="text-sm font-bold col-span-3">TOTAL</label>
              <label className="text-sm font-semibold col-span-2">
        ...
        <div className="flex md:gap-4 gap-1 md:flex-row flex-col px-4 py-4 md:mt-0 ">
          ...
          <div className="relative flex w-full items-center">
            ...
            >
              ...
              {allMesin?.map((data: any, i: number) => {
                return (
                  <option
                    value={data.mesin}
        ...
        <div className="md:grid grid-cols-1 gap-5 px-10 pb-10 ">
          <div className="">
            <div className="flex gap-3 p-3">
              ...
              <p className="text-xl font-semibold text-[#0065DE]">
                {' '}
                Mesin : {oneMesin?.data_jenis_masalah?.jenis_masalah[0]?.mesin}
              </p>
            </div>
          ...
          <div className="flex flex-col ">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                {oneMesin?.data_jenis_masalah?.kode_produksi?.map(
                  (data: any, i: any) => {
                    return (
                      <>
              ...
              <div>
                {oneMesin?.data_jenis_masalah?.kode_quality?.map(
                  (data: any, i: any) => {
                    return (
                      <>
                        <div className="grid grid-cols-12 border-x-2 border-b-2 border-black px-1 justify-center gap-4 bg-white">
      ...
      <div className="bg-white rounded-md shadow-md md:w-12/12 mb-5 border-2">
        ...
        <div className="md:grid grid-cols-1 gap-5 px-10 pb-10 pt-5">
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-11 border-2 border-black px-1 justify-center gap-4 bg-slate-300">
              <label className="text-sm font-bold col-span-7">TOTAL</label>
        ...
        <div className="md:grid grid-cols-1 gap-5 px-10 pb-10 pt-5">
          <div className="">
            ...
            <BarChartProductionQuality
              value={produksiDefect?.produksi_defect}
            />
          </div>
          <div className="flex flex-col">
            <div className="grid grid-cols-11 border-2 border-black px-1 justify-center gap-4 bg-slate-300">
      ...
      <div className="bg-white rounded-md shadow-md md:w-12/12 mb-5 border-2">
        ...
        <div className="flex gap-10 w-full justify-center">
          <label className="text-xl text-blue-400 font-semibold">
            {convertTimeStampToDate(responTimeBulan?.queryDari)} ~{' '}
            {convertTimeStampToDate(responTimeBulan?.querySampai)}
          </label>
        </div>
        <div className="md:grid grid-cols-1 gap-5 px-10 pb-10 pt-5">
          <div className="">
              ...
              return (
                <>
                  <div className="flex  py-1 px-2   border-black  gap-4 pt-4">
                    <label className="text-sm font-semibold">{i + 1}.</label>
                    <label className="text-sm col-span-2 font-semibold">
                      {data.mesin}
                    </label>
                  </div>
      ...
      <div className="bg-white rounded-md shadow-md md:w-12/12 mb-5 border-2">
        ...
        <div className="flex gap-10 w-full justify-center">
          <label className="text-xl text-blue-400 font-semibold">
            {convertTimeStampToDate(breakDownMonth?.queryDari)} ~{' '}
            {convertTimeStampToDate(breakDownMonth?.querySampai)}
          </label>
        </div>
        <div className="md:grid grid-cols-1 gap-5 px-10 pb-10 pt-5">
          <div className="">
                                ...
                                <table className="min-w-full divide-y divide-gray-200 border border-blue-200 rounded-lg overflow-hidden">
                                  ...
                                  <tbody className="bg-white divide-y divide-gray-200">
                                    {data2.details
                                      ...
                                      .sort(
                                        (a: any, b: any) =>
                                          b.breakdownTimeMs - a.breakdownTimeMs,
                                      )
