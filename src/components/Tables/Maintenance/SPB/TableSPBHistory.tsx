              ...
              <div className="min-w-[700px] ">
                <div className="my-2 ">
                  <section className="flex  bg-white  rounded-lg px-2">
                    <div className=" py-3 w-10 px-2 flex justify-start items-center">
                      1
                    </div>
                    <div className="grid  grid-cols-7 w-full ">
                      <div className="flex flex-col md:gap-5 gap-1 ">
                        <div className="my-auto ">
                          <p className="text-xs font-light">EXC800802</p>
                        </div>
                      </div>
                      <div className="flex flex-col md:gap-5 gap-1 ">
                        <div className="my-auto">
                          <p className="text-xs font-light">R700</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center md:gap-5 gap-1 ">
                        <p className="text-xs font-light">2 Juni 2024</p>
                      </div>
                      <div className="flex items-center md:gap-5 gap-1 ">
