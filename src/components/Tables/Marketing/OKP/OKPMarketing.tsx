...
const OKPMarketing: React.FC = () => {
  ...
  const canEditOKP = checkEdit('/marketing/okp/create');
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        {item.posisi_proses === 'customer' && (
                          <button
                            ...
                            className="bg-purple-500 hover:bg-purple-600 text-white px-2 py-1 rounded text-xs transition-colors w-full"
