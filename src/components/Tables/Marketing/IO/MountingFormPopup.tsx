  ...
  useEffect(() => {
    if (mountingData) {
      ...
      setFormData({
        ...
        id_coating_depan: mountingData.id_coating_depan || null,
        id_coating_belakang: mountingData.id_coating_belakang || null,
      ...
      setFormData({
        ...
        keterangan_revisi: '',
        id_coating_depan: templateMounting?.id_coating_depan || null,
        id_coating_belakang: templateMounting?.id_coating_belakang || null,
