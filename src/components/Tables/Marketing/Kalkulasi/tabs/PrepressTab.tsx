...
const PrepressTab: React.FC<PrepressTabProps> = ({
  ...
  useEffect(() => {
    ...
    // Convert pajak to multiplier (e.g., 11 -> 1.11, 12 -> 1.12)
    const pajakMultiplier = 1 + pajak / 100;

    // Calculate harga after tax by dividing
    const hargaAfterTax = harga / pajakMultiplier;
