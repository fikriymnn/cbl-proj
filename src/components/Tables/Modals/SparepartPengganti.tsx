        ...
        <div className="flex flex-col">
          <div className="flex w-full border-t border-neutral-300 px-3 pt-2">
            ...
            <div className="flex items-center w-3/12 justify-center ">
              <p className="text-black text-sm font-light text-center dark:text-white line-clamp-1">
                {spareName}
              </p>
            </div>
            <div className="flex items-center w-3/12 justify-center ">
            ...
            <div className="flex justify-end w-2/12">
              <button
                onClick={onClick}
                className="bg-blue-700 rounded-sm text-white  text-xs font-semibold px-6 py-1"
              >
                PAKAI
              </button>
            </div>
        ...
        <div className="flex flex-col">
          <div className="flex w-full border-t border-neutral-300  pt-2">
            ...
            <div className="flex justify-end w-2/12">
              <button
                onClick={onClick}
                className="bg-blue-700 rounded-sm text-white text-xs font-semibold px-4 py-1"
              >
                PAKAI
              </button>
            </div>
