                ...
                <div className="flex flex-col">
                    ...
                    >
                        ...
                        <div className="flex items-center w-4/12 justify-center p-2.5 ">
                            <p className="text-slate-600 text-[14px] font-semibold text-center dark:text-white">Grade</p>
                        </div>
                        <div className="flex items-center text-[14px] w-4/12 justify-center p-2.5 ">
                            <p className="text-slate-600 font-semibold text-center dark:text-white">Percent</p>
                        </div>
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center w-5/12 justify-center p-2.5 pr-9">
                                            <p className="text-slate-600 text-[14px] font-semibold text-center dark:text-white">{data.grade}</p>
                                        </div>
                                        <div className="flex items-center text-[14px] w-5/12 justify-center p-2.5 pr-9">
                                            <p className="text-slate-600 font-semibold text-center dark:text-white">{data.percent}</p>
                                        </div>
                                                    ...
                                                    <>
                                                        <div className="grid   gap-3 w-full px-5 py-2">
                                                            <>
                                                                ...
                                                                <div className=" pt-3">
                                                                    <button
                                                                        onClick={() => submitEDitMesin(data.id)}
                                                                        className="bg-[#0065DE] text-center text-white text-xs font-bold px-6 py-3 rounded-md"
                                                                    >
                                                                        SIMPAN
                                                                    </button>
