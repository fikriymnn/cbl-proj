        ...
        <>
          ...
          <div className="flex flex-col">
            <div className="flex border-b border-stroke dark:border-strokedark">
              ...
              <div className="flex items-center text-[14px] w-3/12 justify-start p-2.5 pl-8 "></div>
            </div>
            {masterMesin != null &&
                ...
                return (
                  <>
                    ...
                    >
                      ...
                      <div className="flex items-center text-[14px] w-2/12 justify-center p-2.5 pr-9"></div>
                      ...
                      <div className="flex items-center w-3/12 justify-center p-2.5 gap-2">
                        <a
                          href={`/master/maintenance/pm3/checklist/${data.id}`}
                        >
