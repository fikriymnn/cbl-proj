...
import ModalKonfirmasiPm3 from '../../../Modals/Master/PM3/ModalKonfirmasiPm3';
import ModalEditPM3Master from '../../../Modals/Master/PM3/ModalEditPM3Master';
...
const PM3Checklist = () => {
  ...
  async function getPointPm3(id_mesin: any) {
                ...
                <>
                  <div className="flex py-4 flex-col">
                    ...
                    <div className="flex flex-col">
                      ...
                      {data.ms_inspection_task_pm3s.map(
                        (task: any, ii: number) => {
                          return (
                            <>
