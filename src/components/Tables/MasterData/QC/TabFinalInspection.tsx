...
import PointFinal from './FinalInspection/PointFinal';
import PointSubFinal from './FinalInspection/PointSubFinal';
    ...
    >
      <AppBar position="static" className="">
        <ThemeProvider theme={theme}>
          ...
          >
            <Tab label="Point Final" {...a11yProps(0)} className="" />
            <Tab label="Sub Point Final" {...a11yProps(1)} />
          </Tabs>
        </ThemeProvider>
      </AppBar>
