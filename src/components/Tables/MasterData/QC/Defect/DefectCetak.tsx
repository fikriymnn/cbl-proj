...
function DefectCetak() {
    ...
    async function getDefect() {
        const url = `${import.meta.env.VITE_API_LINK}/master/qc/cs/masalahCetak`;
        try {
    ...
    async function editDefect(id: any) {
        const url = `${import.meta.env.VITE_API_LINK}/master/qc/cs/masalahCetak/${id}`;
        try {
            setIsLoading(true);
