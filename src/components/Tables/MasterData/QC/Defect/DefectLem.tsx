...
function DefectLem() {
    ...
    async function getDefect() {
        const url = `${import.meta.env.VITE_API_LINK}/master/qc/cs/masalahLem`;
        try {
    ...
    async function editDefect(id: any) {
        const url = `${import.meta.env.VITE_API_LINK}/master/qc/cs/masalahLem/${id}`;
        try {
            setIsLoading(true);
