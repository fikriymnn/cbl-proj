                ...
                return (
                  <>
                    ...
                    >
                      ...
                      <div className="flex items-center w-2/12 justify-start p-2.5 ">
                        <p className="text-slate-600 text-[14px] font-semibold text-center uppercase dark:text-white">
                          {data.bagian_analisis}
                        </p>
                      </div>
                      <div className="flex items-center text-[14px] w-2/12 justify-start p-2.5 ">
                        <p className="text-slate-600 font-semibold text-center dark:text-white">
                      ...
                      <div className="flex items-center text-[14px] w-5/12 justify-start  p-2.5 ">
                        <p className="text-slate-600 font-semibold text-start">
                          {data.nama_analisis}
                        </p>
                      </div>
      ...
      {isMobile && (
        <>
          ...
          <div className="flex flex-col w-full ">
            <div className="flex border-b border-stroke dark:border-strokedark px-4">
