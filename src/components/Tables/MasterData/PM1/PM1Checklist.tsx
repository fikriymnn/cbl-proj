        ...
        <>
          <div className="flex w-full  gap-2 pr-8 border-b-6 border-[#D8EAFF] px-4 pb-5">
            ...
            <div className="flex w-3/12 justify-end">
              <a
                href={`/masterdata/masterpm1/pm1checklist/addinspection/${mesin != null && mesin.id
                  }`}
              >
                ...
                <>
                  <div className="flex py-4 flex-col">
                    ...
                    <div className="flex w-full flex-row gap-4 pt-3 px-4">
                      ...
                      <div className="flex flex-row gap-3">
                        <button onClick={() => openEdit(i)} className="bg-[#0065DE] text-center text-white text-xs font-bold px-4 py-2 rounded-md">
                          EDIT
                        </button>
                        {showEdit[i] == true && (
                          <ModalEditPM1Master
                        ...
                        <button onClick={() => openDelete(i)} className="bg-[#DE0000] text-center text-white text-xs font-bold px-2 py-2 rounded-md">
                          DELETE
                        </button>
                        {showDelete[i] == true && (
                          <ModalKonfirmasi
                    ...
                    <div className='flex flex-col px-2'>
                      <div className="flex w-full  pt-6 border-b border-stroke">
                        <label className="text-black text-xs font-bold pl-2">TASK LIST</label>
                      </div>
                      {data.ms_inspection_task_pm1s.map((task: any, ii: number) => {
                        return (
                          <>
