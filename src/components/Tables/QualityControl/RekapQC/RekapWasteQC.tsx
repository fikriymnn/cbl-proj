...
function RekapWasteQC() {
  ...
  const filteredJo =
    waste?.dataWasteByJo?.filter((data: any) => {
  ...
  const filteredJo2 =
    waste?.dataWasteByJoReplace?.filter((data: any) => {
      if (!data) return true; // Tetap tampilkan data meskipun null
      ...
      return (
        ...
        normalizeString(data.nama_produk).includes(
  ...
  const [showModalWaste, setShowModalWaste] = useState<{
  ...
  const [showModalKendala, setShowModalKendala] = useState<{
    [key: number]: { [key: number]: boolean };
  }>({});
          ...
          <table className="w-full border-collapse border-x border-y border-gray-300 bg-white py-4">
            <thead>
              <tr className="bg-blue-100 border-b border-gray-300">
                <th className="px-5 py-2 text-sm font-bold text-blue-500 text-left border-x border-gray-300">
                  Detail By Kategori
                </th>
                <th className="px-5 py-2 text-sm font-bold text-black text-left border-x border-gray-300">
                  Qty
                </th>
                <th className="px-5 py-2 text-sm font-bold text-black text-left border-x border-gray-300">
                  % Qty
            ...
            <tbody>
              {(() => {
                const totalDefects =
                  waste?.dataByKategori?.dataKendala?.reduce(
                    (sum: number, kendala: any) =>
                      sum + (kendala.total_calculated_defect || 0),
                    0,
                  ) || 0;
                ...
                return waste?.dataByKategori?.dataKendala?.map(
                  (kendala: any, i: number) => {
                    const qty = kendala.total_calculated_defect || 0;
                    const percentage =
                      totalDefects > 0
                        ? ((qty / totalDefects) * 100).toFixed(2)
                        : '0';
                    const joPercentage =
                      totalJoLength > 0
                        ? ((kendala.jo.length / totalJoLength) * 100).toFixed(2)
                        : '0';
                      ...
                      <tr key={i} className="border-b border-gray-300">
                        {kendala.kategori_kendala == 'Mesin' ? (
                          <>
                            ...
                            >
                              {kendala.kategori_kendala == 0 ||
                              kendala.kategori_kendala == null
                                ? '0'
                                  ...
                                  <>
                                    ...
                                    <div className="overflow-x-auto">
                                      <table className="w-full border-collapse border border-gray-300 mt-2">
                                        ...
                                        <tbody>
                                          {waste?.dataByKategori
                                            ?.dataKendalaMesin?.length > 0 ? (
                                            [
                                              ...waste.dataByKategori
                                                .dataKendalaMesin,
                                            ]
                                              .sort(
                                                (a: any, b: any) =>
                                                  b.total_calculated_defect -
                                                  a.total_calculated_defect,
                                              ) // Sort Descending
                                                      ...
                                                      {jo.mesin
                                                        ...
                                                        .map(
                                                          (
                                                            ...
                                                            mesin.operator_inspektor &&
                                                            mesin
                                                              .operator_inspektor
                                                              .length > 0 ? (
                                                              mesin.operator_inspektor.map(
                                                                (
                                                                  kendala: any,
                                                                  kendalaIndex: any,
                                                                ) => (
                                                                  <tr
                                                                    key={`${mesinIndex}-${kendalaIndex}`}
                                                                    className="border border-gray-300"
                                                                  >
                                                                    {kendalaIndex ===
                                                                      0 && ( // Only show Mesin & Defect for the first row
                                                                      <>
                                                                        <td
                                                                          rowSpan={
                                                                            mesin
            ...
            <thead>
              <tr className="bg-blue-100 border-b border-gray-300 border-x border-gray-300 ">
                <th
                  colSpan={2}
                  className="px-5 py-2 text-sm font-bold text-black text-left border-x border-gray-300 "
                >
                  {' '}
                  Total JO Waste: {waste?.dataWasteByJo?.length}
                </th>
                <th
                  colSpan={2}
                  className="px-5 py-2 text-sm font-bold text-black text-left border-x border-gray-300"
                >
                  {' '}
                  Total JO Kendala: {waste?.dataWasteByJoReplace?.length}
                </th>
              </tr>
            </thead>
          </table>
            ...
            <div className="border-8 border-[#D8EAFF] flex flex-col gap-2 ">
              <div className="flex  bg-white py-2 px-2 flex-col">
                ...
                <label className="text-xl text-blue-400 font-semibold">
                  {dateFrom == null ? '' : convertTimeStampToDate(dateFrom)} ~{' '}
                  {dateTo == null ? '' : convertTimeStampToDate(dateTo)}
                </label>
                ...
                <input
                  ...
                  className="border-2 border-stroke rounded-md w-[30%]  px-2 py-1 "
                  placeholder="Cari Jo, IO, Customer, Produk"
                />
              </div>
              ...
              {filteredJo?.map((data: any, i: any) => {
                return (
                  <>
                    <div
                      key={i}
                      className="rounded-md max-w-screen gap-2 flex flex-col overflow-x-auto text-stone-400 bg-white border-2 border-black"
                    >
                      {/* Top Content */}
                      <div
                              ...
                              <>
                                <div className="grid grid-cols-4 px-4 py-4">
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.POTONG?.data?.sortir_RS?.map(
                                      (sortir: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.POTONG?.data?.sampling_rabut?.map(
                                      (sampling: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.POTONG?.data?.ampar_lem?.map(
                                      (ampar: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.POTONG?.data?.helper?.map(
                                      (helper: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                              ...
                              <>
                                <div className="grid grid-cols-4 px-4 py-4">
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.CETAK?.data?.sortir_RS?.map(
                                      (sortir: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.CETAK?.data?.sampling_rabut?.map(
                                      (sampling: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.CETAK?.data?.ampar_lem?.map(
                                      (ampar: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.CETAK?.data?.helper?.map(
                                      (helper: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                              ...
                              <>
                                <div className="grid grid-cols-4 px-4 py-4">
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.COATING?.data?.sortir_RS?.map(
                                      (sortir: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.COATING?.data?.sampling_rabut?.map(
                                      (sampling: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.COATING?.data?.ampar_lem?.map(
                                      (ampar: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.COATING?.data?.helper?.map(
                                      (helper: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                              ...
                              <>
                                <div className="grid grid-cols-4 px-4 py-4">
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.POND?.data?.sortir_RS?.map(
                                      (sortir: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.POND?.data?.sampling_rabut?.map(
                                      (sampling: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.POND?.data?.ampar_lem?.map(
                                      (ampar: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.POND?.data?.helper?.map(
                                      (helper: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                              ...
                              <>
                                <div className="grid grid-cols-4 px-4 py-4">
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.LEM?.data?.sortir_RS?.map(
                                      (sortir: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.LEM?.data?.sampling_rabut?.map(
                                      (sampling: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.LEM?.data?.ampar_lem?.map(
                                      (ampar: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.LEM?.data?.helper?.map(
                                      (helper: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                              ...
                              <>
                                <div className="grid grid-cols-4 px-4 py-4">
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.LIPAT?.data?.sortir_RS?.map(
                                      (sortir: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.LIPAT?.data?.sampling_rabut?.map(
                                      (sampling: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.LIPAT?.data?.ampar_lem?.map(
                                      (ampar: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    {data.defectsByKategori?.LIPAT?.data?.helper?.map(
                                      (helper: any, i: any) => (
                                        <>
                                          <label
                                            key={i}
                        ...
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            {data.defects
                              ...
                              ) // Sort by total_defect DESCENDING
                              .map((data2: any, ii: number) => (
                                <React.Fragment key={ii}>
                                  {Array.isArray(data2.kendala) &&
                                  data2.kendala.length > 0 ? (
                                    data2.kendala
                                      ...
                                      ) // Sort by calculated_defect DESCENDING
                                      .map((data3: any, iii: number) => (
                                        <tr
                                          key={`${data2.kode_waste}-${iii}`}
                                          className="border-b border-gray-300"
                                        >
                                  ...
                                  {showModalWaste[i]?.[ii] && (
                                    ...
                                    >
                                      <>
                                        ...
                                        data2.verifikator_inspektor.length >
                                          0 ? (
                                          data2.verifikator_inspektor
                                            .flat()
                                            .some(
                                            ...
                                            <div className="mt-4">
                                              <h3 className="font-semibold mb-2">
                                                Detail Teknisi QC / Verifikator
                                                QC Berdasarkan Kode Waste
                                              </h3>
                                              <table className="w-full border-collapse border border-gray-300">
                                                <thead>
                                                    ...
                                                    .reduce(
                                                      (
                                                        ...
                                                        if (
                                                          !acc.some(
                                                            (item) =>
                                                              `${item.kode_mr}-${item.tanggal_tiket}-${item.inspektor_mtc}` ===
                                                              key,
                                                          )
                                                        ) {
                                                          acc.push(inspektor);
                                                        ...
                                                        >
                                                          ...
                                                          <td className="border border-gray-300 px-4 py-2">
                                                            {convertTimeStampToDate(
                                                              inspektor?.tanggal_tiket,
                                                            ) || '-'}
                                                          </td>
                                                          <td className="border border-gray-300 px-4 py-2">
                                                            {inspektor?.inspektor_mtc ||
                                                              '-'}
                                                          </td>
                                                          <td className="border border-gray-300 px-4 py-2">
                                                            {inspektor?.verifikator_qc ||
                                                              '-'}
                                                          </td>
                                                          <td className="border border-gray-300 px-4 py-2">
                                                            {inspektor?.operator ||
                                            ...
                                            <p className="mt-4 text-gray-500">
                                              Tidak ada data inspektor QC /
                                              Teknisi QC yang memiliki waste{' '}
                                              {data2.kode_waste}
                                            </p>
                                          )
                                        ) : (
                                        ...
                                        {Array.isArray(
                                          data2.operator_inspektor,
                                        ) &&
                                        data2.operator_inspektor.length > 0 ? (
                                          data2.operator_inspektor.some(
                                            (item: any) =>
                                              item &&
                                              Object.keys(item).length > 0,
                                          ) ? (
                                                      ...
                                                      <>
                                                        ...
                                                        >
                                                          ...
                                                          >
                                                            ...
                                                            {Array.isArray(
                                                              inspektor?.verifikator_inspektor,
                                                            ) &&
                                                            inspektor
                                                              .verifikator_inspektor
                                                              .length > 0 &&
                                                            inspektor.verifikator_inspektor.some(
                                                              (item: any) =>
                                                                item &&
                                                                Object.keys(
                                                                  item,
                                                              ...
                                                              <table className="w-full border-collapse border border-gray-200">
                                                                ...
                                                                <tbody>
                                                                  {inspektor?.verifikator_inspektor?.map(
                                                                    (
                                                                      verif: any,
                                                                      verifIndex: number,
                                                                    ) => (
                      ...
                      .map((data: any, i: any) =>
                        data.kendala?.length > 0 ? (
                          ...
                          [...data.kendala]
                            .sort(
                              (a: any, b: any) =>
                                b.calculated_defect - a.calculated_defect,
                            )
                                  ...
                                  data2.kendala.length > 0 ? (
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        -{' '}
                                        {data2.kode_kendala || 'Tidak ada Kode'}{' '}
                                        -{' '}
                                        {data2.kendala_desc ||
                                          'Tidak ada Deskripsi'}
                                      </td>
                                      ...
                                      <>
                                        ...
                                        data2.verifikator_inspektor.length >
                                          ...
                                          data2.verifikator_inspektor
                                            ...
                                            <p className="mt-4 text-gray-500">
                                              Tidak ada data inspektor QC /
                                              Teknisi QC yang memiliki Kendala{' '}
                                              {data2.kendala_desc}
                                            </p>
                                          )
                                        ) : (
                            ...
                            .map((data2: any, ii: any) => (
                              ...
                              >
                                ...
                                {ii === 0 && (
                                  <>
                                    <td
                                      rowSpan={data.kode_waste?.length}
                                      className="border border-gray-300 px-4 py-2 font-semibold text-center"
                                    >
