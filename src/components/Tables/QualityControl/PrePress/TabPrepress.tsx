...
import ProsesPrepress from './ProsesPrepress';
import HistoryPrepress from './HistoryPrepress';
...
export default function TabPrePress() {
                ...
                <AppBar position="static" className="">
                    <ThemeProvider theme={theme}>
                        ...
                        >
                            ...
                            <Tab label="History Prepress" {...a11yProps(1)} />
