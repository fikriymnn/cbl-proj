...
function IncomingNCRQC() {
  ...
  async function getNcrQC() {
    ...
    }/capa?id_department=10&status=incoming
        `;
    try {
          ...
          <>
            <div className=" flex bg-white py-2 w-full mt-2 mb-2 px-5 text-sm font-semibold rounded-md  items-center">
              ...
              <div className="grid grid-cols-12 w-full text-[#6c6b6b] text-sm font-light items-center">
                ...
                <div className="col-span-2 text-red-700 bg-yellow-300 rounded-full flex w-full text-center justify-center uppercase">
                  {data?.status}
                </div>
                                        ...
                                        <>
                                          <div className="flex w-full px-4 py-4">
                                            <div className="flex flex-col w-full">
                                              ...
                                              <input
                                                type="date"
                                                name="tanggal_pencegahan_efektif_dilakukan"
                                                onChange={(e) =>
                                                  handleChangePoint(e, i, ii)
                                                }
                                                className="peer h-full min-h-[20px] w-full resize-none rounded-[7px] border border-stroke bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 focus:border-2 focus:border-gray-900 focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50"
                                              ></input>
