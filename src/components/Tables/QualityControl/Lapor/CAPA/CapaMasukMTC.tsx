...
function CapaLaporMasukQC() {
  ...
  async function getCapa() {
    ...
    }/capa?department=qc&statusNotEqual=incoming&bagian_tiket=incoming
        `;
    try {
                                ...
                                <>
                                  ...
                                  <div className="grid grid-cols-2 w-full px-4 py-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                      ...
                                      <p className="text-xl font-normal ">
                                        {data?.catatan_verifikasi_qa == null
                                          ? '-'
                                          : data?.catatan_verifikasi_qa}
                                      </p>
                                      <p className="text-sm font-semibold text-black pt-2">
                                        CATATAN CAPA MR
                                      </p>
                                      <p className="text-xl font-normal ">
                                        {data?.catatan_verifikasi_mr == null
                                          ? '-'
                                          : data?.catatan_verifikasi_mr}
                                      </p>
                                    </div>
                                  </div>
                                          ...
                                          <div className="flex w-full px-4 py-4">
                                            <div className="flex flex-col w-full">
                                              ...
                                              <textarea
                                                ...
                                                defaultValue={
                                                  data2?.pencegahan_efektif_dilakukan
                                                }
                                                className="peer h-full min-h-[100px] w-full resize-none rounded-[7px] border border-stroke bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 focus:border-2 focus:border-gray-900 focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50"
                                              ></textarea>
