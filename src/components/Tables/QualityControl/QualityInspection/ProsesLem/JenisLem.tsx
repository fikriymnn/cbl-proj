...
function JenisLemMesin() {
  ...
  const jumlahWaktuCheck = formatElapsedTime(
    cetakMesin?.data?.inspeksi_lem_awal[0]?.waktu_check,
  );
  return (
    <>
      {isOpen && (
            ...
            <div id="print-area" className="p-6 bg-white">
              <div className="min-w-full bg-white">
                      ...
                      <tr className="">
                        ...
                        <td className="p-2 border-b border-gray-300">
                          ...
                          <input
                            type="text"
                            disabled
                            defaultValue={cetakMesin?.data?.jenis_lem}
                          />
                        </td>
                        <td className="p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          Nama Produk
                ...
                <div className="mb-8">
                  ...
                  {cetakMesin?.data?.inspeksi_lem_awal[0]?.inspeksi_lem_awal_point?.map(
                    (data: any, index: any) => {
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="w-1/3 p-2 border border-gray-300">
                            <span>
                              {
                                cetakMesin?.data?.inspeksi_lem_awal[0]
                                  ?.jumlah_periode
                              }
                            </span>
                          </td>
                ...
                <div className="mb-8">
                  ...
                  {cetakMesin?.data?.inspeksi_lem_periode[0]?.inspeksi_lem_periode_point?.map(
                    (data: any, index: any) => {
                      const lamaPengerjaan = formatElapsedTime(
                        data.lama_pengerjaan,
                      );
                          ...
                          <div className="p-3">
                            ...
                            <div className="mt-2 overflow-x-auto">
                              ...
                              {(() => {
                                ...
                                for (
                                  let i = 0;
                                  i < data.inspeksi_lem_periode_defect.length;
                                  i += 10
                                ) {
                                  chunks.push(
                                    data.inspeksi_lem_periode_defect.slice(
                                      i,
                                      i + 10,
                                    ),
                                  );
      ...
      <main className="overflow-x-scroll">
        <div className="min-w-[700px] bg-white rounded-xl">
          ...
          <div className=" w-full h-full flex-col border-b-8 border-[#D8EAFF]">
            ...
            {cetakMesin?.data?.inspeksi_lem_awal.length > 0 ? (
            ...
            {cetakMesin?.data?.inspeksi_lem_periode.length > 0 ? (
              <div className="flex  border-b-8 border-[#D8EAFF] gap-7 items-center">
                <div className="flex items-center gap-7 w-full">
                  <div
                    className={`w-2 h-full sticky left-0 z-20 ${
