...
import ProsesLemMesin from './ProsesLemMesin';
import ProsesLemMesinHistory from './ProsesLemMesinHistori';
import ProsesLemMesinPending from './ProsesLemMesinPending';
    ...
    <>
      ...
      >
        ...
        <TabPanel value={value} index={1} dir={theme.direction}>
          <ProsesLemMesinPending />
        </TabPanel>
        <TabPanel value={value} index={2} dir={theme.direction}>
          <ProsesLemMesinHistory />
        </TabPanel>
      </Box>
    </>
  );
