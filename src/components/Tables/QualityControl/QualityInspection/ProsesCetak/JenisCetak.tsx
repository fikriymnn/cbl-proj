          ...
          <div className=" w-full h-full flex-col border-b-8 border-[#D8EAFF]">
            ...
            {cetakMesin?.data?.inspeksi_cetak_awal.length > 0 ? (
              <div className="flex  border-b-8 border-[#D8EAFF] gap-7 items-center">
                <div className="flex items-center gap-7 w-full">
                  <div
                    className={`w-2 h-full sticky left-0 z-20 ${cetakMesin?.data?.inspeksi_cetak_awal[0].status ==
                      'incoming'
                      ? 'bg-red-500'
                      : 'bg-green-500'
                      }  gap-8 py-7 `}
            ...
            {cetakMesin?.data?.inspeksi_cetak_periode.length > 0 ? (
              <div className="flex  border-b-8 border-[#D8EAFF] gap-7 items-center">
                <div className="flex items-center gap-7 w-full">
                  <div
                    className={`w-2 h-full sticky left-0 z-20 ${cetakMesin?.data?.inspeksi_cetak_periode[0].status ==
                      'incoming'
                      ? 'bg-red-500'
                      : 'bg-green-500'
                      }  gap-8 py-7 `}
