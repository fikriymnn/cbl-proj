...
function CheckSheetCoatingPeriode() {
    ...
    const handleChangePoint = (e: any, i: number) => {
        ...
        onchangeVal.inspeksi_pond_periode[0].inspeksi_pond_periode_point[i][
            name
        ] = value;
                    ...
                    <div className="min-w-[700px] bg-white rounded-xl">
                        ...
                        <div className='grid grid-cols-12  border-b-8 border-[#D8EAFF]'>
                            ...
                            <div className='grid grid-rows-6 gap-2 col-span-2  py-4'>
                                ...
                                <label className='text-neutral-500 text-sm font-semibold'>
                                    : {pondMesinPeriode?.jumlah_druk} / Isi :  {pondMesinPeriode?.mata}
                                </label>
                                <label className='text-neutral-500 text-sm font-semibold'>
                                    ...
                                    <>
                                        ...
                                        <div className="flex overflow-x-scroll ">
                                            {data?.inspeksi_pond_periode_defect?.map(
                                                (data2: any, i: number) => {
                                                    return (
                                                        <div className={`flex flex-col w-[120px] justify-center py-4  ${(i + 1) % 2 === 0 ? ' bg-[#F3F3F3]' : 'bg-white'} items-center gap-2`}>
                                                            ...
                                                            {data.status == 'done' ? (
                                                                <select
                                                                    ...
                                                                    className={`w-[80%]  ${(i + 1) % 2 === 1 ? ' bg-[#F3F3F3]' : 'bg-white'} `}
                                                                >
                                                                ...
                                                                <select
                                                                    ...
                                                                    className={`w-[80%]  ${i % 2 === 1 ? ' bg-[#F3F3F3]' : 'bg-white'} `}
                                                                >
