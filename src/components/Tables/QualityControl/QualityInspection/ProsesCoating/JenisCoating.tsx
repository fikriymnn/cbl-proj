...
function JenisCoatingMesin() {
  ...
  const jumlahWaktuCheck = formatElapsedTime(
    coatingMesin?.data?.inspeksi_coating_sub_awal[0]?.waktu_check,
  );
  return (
    <>
      {isOpen && (
            ...
            <div id="print-area" className="p-6 bg-white">
              <div className="min-w-full bg-white">
                  ...
                  <table className="w-full border-collapse">
                    <tbody>
                      <tr>
                        ...
                        <td className="w-1/6 p-2 border-b border-gray-300">
                          {': '}
                          {convertDateToTime(coatingMesin?.data?.createdAt)}
                        </td>
                        <td className="w-1/6 p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          Shift
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="p-2 border-b border-gray-300">
                          {': '}
                          {formatInteger(
                            parseInt(coatingMesin?.data?.jumlah_druk),
                          )}{' '}
                          / {formatInteger(parseInt(coatingMesin?.data?.mata))}
                        </td>
                        <td className="p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          No. JO
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="p-2 border-b border-gray-300">
                          {': '}
                          {formatInteger(
                            parseInt(coatingMesin?.data?.jumlah_pcs),
                          )}
                        </td>
                        <td className="p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          No. IO
                      ...
                      <tr>
                        ...
                        <td className="p-2 border-b border-gray-300">
                          {': '}
                          {coatingMesin?.data?.jenis_kertas}
                        </td>
                        <td className="p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          Nama Produk
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="p-2 border-b border-gray-300">
                          {': '}
                          {coatingMesin?.data?.jenis_gramatur}
                        </td>
                        <td className="p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          Customer
                        </td>
                ...
                <div className="mb-8">
                  ...
                  {coatingMesin?.data?.inspeksi_coating_result_awal?.map(
                    (data: any, index: any) => {
                          ...
                          <td className="border border-gray-300 p-2">
                            <div className="flex items-center gap-2">
                              <span>
                                {
                                  coatingMesin?.data
                                    ?.inspeksi_coating_sub_awal[0]?.sample_1
                                }{' '}
                                gr
                              </span>
                              <span>
                          ...
                          <td className="border border-gray-300 p-2">
                            <div className="flex items-center gap-2">
                              <span>
                                {
                                  coatingMesin?.data
                                    ?.inspeksi_coating_sub_awal[0]?.sample_2
                                }{' '}
                                gr
                              </span>
                              <span>
                          ...
                          <td className="border border-gray-300 p-2">
                            <div className="flex items-center gap-2">
                              <span>
                                {
                                  coatingMesin?.data
                                    ?.inspeksi_coating_sub_awal[0]?.sample_3
                                }{' '}
                                gr
                              </span>
                              <span>
                ...
                <div className="mb-8">
                  ...
                  {coatingMesin?.data?.inspeksi_coating_result_periode?.map(
                    (data: any, index: any) => {
                      const lamaPengerjaan = formatElapsedTime(
                        data.lama_pengerjaan,
                      );
                            ...
                            <table className="w-full border-collapse border border-gray-300 mb-4">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td className="p-2 border border-gray-300">
                                    <span>{data.nilai_glossy_kiri}</span>
                                  </td>
                                  ...
                                  <td className="p-2 border border-gray-300">
                                    <span>{data.nilai_glossy_tengah}</span>
                                  </td>
                                  <td className="p-2 border border-gray-300 bg-gray-50">
                                    <span className="text-neutral-500 text-sm font-semibold">
                                      Nilai Glossy Kanan
                                  ...
                                  <td className="p-2 border border-gray-300">
                                    <span>{data.nilai_glossy_kanan}</span>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                            ...
                            <div className="mt-2 overflow-x-auto">
                              ...
                              {(() => {
                                ...
                                for (
                                  ...
                                  chunks.push(
                                    data.inspeksi_coating_result_point_periode.slice(
                                      i,
                                      i + 10,
                                    ),
                                  );
                        ...
                        <td className="border border-gray-300 p-2">
                          <div className="flex items-center gap-2">
                            <span>
                              {
                                coatingMesin?.data
                                  ?.inspeksi_coating_sub_periode[0]?.sample_1
                              }{' '}
                              gr
                            </span>
                            <span>
                              ...
                              {
                                coatingMesin?.data
                                  ?.inspeksi_coating_sub_periode[0]
                                  ?.hasil_sample_1
                              }{' '}
                              g/m<sup>2</sup>
                            </span>
                        ...
                        <td className="border border-gray-300 p-2">
                          <div className="flex items-center gap-2">
                            <span>
                              {
                                coatingMesin?.data
                                  ?.inspeksi_coating_sub_periode[0]?.sample_2
                              }{' '}
                              gr
                            </span>
                            <span>
                        ...
                        <td className="border border-gray-300 p-2">
                          <div className="flex items-center gap-2">
                            <span>
                              {
                                coatingMesin?.data
                                  ?.inspeksi_coating_sub_periode[0]?.sample_3
                              }{' '}
                              gr
                            </span>
                            <span>
      ...
      <main className="overflow-x-scroll">
        <div className="min-w-[700px] bg-white rounded-xl">
          ...
          <div className=" w-full h-full flex-col border-b-8 border-[#D8EAFF]">
            <div className="grid grid-cols-10 px-10 py-4 items-center border-b-8 border-[#D8EAFF] gap-2 ">
            ...
            {coatingMesin?.data?.inspeksi_coating_sub_awal.length > 0 ? (
              <div className="flex  border-b-8 border-[#D8EAFF] gap-7 items-center">
                <div className="flex items-center gap-7 w-full">
                  <div
                    className={`w-2 h-full sticky left-0 z-20 ${
                      coatingMesin?.data?.inspeksi_coating_sub_awal[0].status ==
                      'incoming'
                        ? 'bg-red-500'
                        : 'bg-green-500'
                    }  gap-8 py-7 `}
                ...
                <div className="justify-end flex pr-2 w-full ">
                  <Link to={`/qc/inspection/coating/jenis/check-awal/${id}`}>
                    <button
            ...
            {coatingMesin?.data?.inspeksi_coating_sub_periode.length > 0 ? (
              <div className="flex  border-b-8 border-[#D8EAFF] gap-7 items-center">
                ...
                <div className="justify-end flex pr-2 w-full ">
                  <Link to={`/qc/inspection/coating/jenis/check-periode/${id}`}>
                    <button
                      className={`uppercase px-14 inline-flex rounded-[3px] items-center text-white text-xs font-bold  py-2 my-2   hover:bg-blue-400 border bg-blue-600 border-blue-600  justify-center`} // Dynamic class assignment
                    >
                      PILIH
