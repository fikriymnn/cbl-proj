...
function ProsesCoatingMesinHistory() {
          ...
          <div className=" w-full h-full flex-col border-b-8 border-[#D8EAFF]">
            ...
            {CoatingMesin != null &&
              CoatingMesin.data?.map((data: any, i: any) => {
                ...
                const periodeCount =
                  data.inspeksi_coating_result_periode?.length ?? 0;
                return (
                  <>
                    <div
                    ...
                    >
                      ...
                      <div className="justify-end flex pr-2 ">
                        <>
                          <Link to={`/qc/inspection/coating/jenis/${data.id}`}>
                            <button
...
export default ProsesCoatingMesinHistory;
