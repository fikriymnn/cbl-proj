...
function CheckSheetCoatingAwal() {
  ...
  const [coatingMesinAwalHistory, setcoatingMesinAwalHistory] = useState<any>();
                      ...
                      <>
                        <div className="grid grid-cols-12  border-b-8 border-[#D8EAFF]">
                          ...
                          <div className="grid grid-rows-6 gap-2 col-span-2  py-4">
                            ...
                            <label className="text-neutral-500 text-sm font-semibold">
                              : {coatingMesinAwalHistory?.jenis_kertas}
                            </label>
                            <label className="text-neutral-500 text-sm font-semibold">
                              : {coatingMesinAwalHistory?.jenis_gramatur}
                            </label>
                            <label className="text-neutral-500 text-sm font-semibold">
                              : {coatingMesinAwalHistory?.coating}
                            </label>
                          </div>
                          ...
                          <div className="grid grid-rows-6  gap-2 col-span-2 justify-between px-2 py-4">
                            ...
                            <label className="text-neutral-500 text-sm font-semibold">
                              : {coatingMesinAwalHistory?.customer}
                            </label>
                          </div>
                          <div className="grid grid-rows-6  gap-2 col-span-2 justify-between px-10 py-4">
                            <label className="text-neutral-500 text-sm font-semibold">
                          ...
                          <div className="grid grid-rows-6  gap-2 col-span-2 justify-between px-2 py-4">
                            <label className="text-neutral-500 text-sm font-semibold">
                              : {coatingMesinAwalHistory?.shift}
                            </label>
                            <label className="text-neutral-500 text-sm font-semibold">
                              : {coatingMesinAwalHistory?.mesin}
                            </label>
                            <label className="text-neutral-500 text-sm font-semibold">
                              : {coatingMesinAwalHistory?.operator}
                            </label>
                            <label className="text-neutral-500 text-sm font-semibold">
                              : {coatingMesinAwalHistory?.status_jo}
                            </label>
                          </div>
                        </div>
