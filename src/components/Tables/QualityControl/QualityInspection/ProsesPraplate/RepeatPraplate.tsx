...
function ProsesPraplateRepeat() {
    ...
    const openModalModal = () => setShowModal(true);
    const closeModalModal = () => setShowModal(false);
    return (
        <>
            {!isMobile && (
                                ...
                                pondMesin.data?.map((data: any, i: any) => (
                                    <>
                                        <div className='grid grid-cols-10 border-b-8 border-[#D8EAFF] gap-2 items-center '>
                                            ...
                                            <label className='text-neutral-500 text-sm font-semibold col-span-6 uppercase'>
