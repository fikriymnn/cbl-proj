                                    ...
                                    <div className='flex flex-col gap-1 col-span-2'>
                                        <div>
                                            <input
                                                ...
                                                type="radio" id="sesuai1" name="sesuai1" value="presisi" />
                                            <label className='pl-2'>Sesuai</label>
                                        </div>
                                        <div>
                                            <input

                                                type="radio" id="sesuai12" name="sesuai1" value="tidak presisi" />
                            ...
                            <div className='flex flex-col gap-1 col-span-2'>
                                <div>
                                    <input
                                        ...
                                        type="radio" id="LANJUT1" name="LANJUT1" value="presisi" />
                                    <label className='pl-2 font-semibold text-[#6c6b6b] '>LANJUT PROSES</label>
                                </div>
                                <div>
                                    <input

                                        type="radio" id="LANJUT12" name="LANJUT1" value="tidak presisi" />
                                    <label className='pl-2 font-semibold text-[#6c6b6b] '>REJECT</label>
                                </div>
                            </div>
