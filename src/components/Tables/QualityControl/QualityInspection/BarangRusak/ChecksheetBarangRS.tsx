...
function CheckSheetBarangRS() {
    ...
    // );
    const isOnprogres = cetakMesinAwal?.barang_rusak_defect?.some((data: { status: any; }) => data?.status == 'incoming')
                            ...
                            <>
                                {cetakMesinAwal?.inspeksi_barang_rusak_defect?.map(
                                    (data: any, i: number) => {
                                        return (
                                            <>
                                                {cetakMesinAwal?.inspeksi_barang_rusak_defect[i].status == 'done' ?
                                                    (
                                                        <>
                            ...
                            <div className="grid col-span-6 items-end justify-end gap-2">
                                {!isOnprogres &&
                                    ...
                                    <>
                                        <button
                                            onClick={() =>
                                                simpanBarangRusak(cetakMesinAwal?.id, cetakMesinAwal?.waktu_sortir, catatan)
                                            }
