...
function ProsesIncomingOutsourcingBarangJadi() {
  ...
  async function getRabutMesin() {
    const url = `${import.meta.env.VITE_API_LINK}/qc/cs/IncomingOutsourcingBarangJadi`;
    try {
                ...
                <>
                  <div className="grid grid-cols-10 border-b-8 border-[#D8EAFF] gap-2 items-center">
                    ...
                    <div className="justify-end flex pr-2 col-span-2">
                      <>
                        <Link
                          to={`/qc/qualityinspection/incoming_outsourcing_barang_jadi/checkAwal/${data.id}`}
                        >
                          <button
...
export default ProsesIncomingOutsourcingBarangJadi;
