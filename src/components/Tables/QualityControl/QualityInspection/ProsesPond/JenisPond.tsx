...
function JenisPondMesin() {
  ...
  const jumlahWaktuCheck = formatElapsedTime(
    pondMesin?.data?.inspeksi_pond_awal[0]?.waktu_check,
  );
  return (
    <>
      {isOpen && (
            ...
            <div id="print-area" className="p-6 bg-white">
              <div className="min-w-full bg-white">
                  ...
                  <table className="w-full border-collapse">
                    <tbody>
                      <tr className="">
                        ...
                        <td className="w-1/6 p-2 border-b border-gray-300">
                          {': '}
                          {convertDateToTime(pondMesin?.data?.createdAt)}
                        </td>
                        <td className="w-1/6 p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          Shift
                        </td>
                      ...
                      <tr className="">
                        ...
                        <td className="p-2 border-b border-gray-300">
                          {': '}
                          {formatInteger(
                            parseInt(pondMesin?.data?.jumlah_druk),
                          )}{' '}
                          / {formatInteger(parseInt(pondMesin?.data?.mata))}
                        </td>
                        <td className="p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          No. JO
                        </td>
                      ...
                      <tr className="">
                        ...
                        <td className="p-2 border-b border-gray-300">
                          {': '}
                          {formatInteger(parseInt(pondMesin?.data?.jumlah_pcs))}
                        </td>
                        <td className="p-2 bg-gray-50 text-neutral-500 text-sm font-semibold">
                          No. IO
                        </td>
                ...
                <div className="mb-8">
                  ...
                  {pondMesin?.data?.inspeksi_pond_awal[0]?.inspeksi_pond_awal_point?.map(
                    (data: any, index: any) => {
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="w-1/3 p-2 border border-gray-300">
                            <span>
                              {
                                pondMesin?.data?.inspeksi_pond_awal[0]
                                  ?.jumlah_periode
                              }
                            </span>
                          </td>
                ...
                <div className="mb-8">
                  ...
                  {pondMesin?.data?.inspeksi_pond_periode[0]?.inspeksi_pond_periode_point?.map(
                    (data: any, index: any) => {
                      const lamaPengerjaan = formatElapsedTime(
                        data.lama_pengerjaan,
                      );
                          ...
                          <div className="p-3">
                            ...
                            <div className="mt-2 overflow-x-auto">
                              ...
                              {(() => {
                                ...
                                for (
                                  let i = 0;
                                  i < data.inspeksi_pond_periode_defect.length;
                                  i += 10
                                ) {
                                  chunks.push(
                                    data.inspeksi_pond_periode_defect.slice(
                                      i,
                                      i + 10,
                                    ),
                                  );
                ...
                <div className="flex items-center gap-7 w-full">
                  <div
                    className={`w-2 h-full sticky left-0 z-20 ${
                      pondMesin?.data?.inspeksi_pond_awal[0].status ==
                      'incoming'
                        ? 'bg-red-500'
                        : 'bg-green-500'
                    }  gap-8 py-7 `}
            ...
            {pondMesin?.data?.inspeksi_pond_periode.length > 0 ? (
              <div className="flex  border-b-8 border-[#D8EAFF] gap-7 items-center">
                <div className="flex items-center gap-7 w-full">
                  <div
                    className={`w-2 h-full sticky left-0 z-20 ${
                      pondMesin?.data?.inspeksi_pond_periode[0].status ==
                      'incoming'
                        ? 'bg-red-500'
                        : 'bg-green-500'
                    }  gap-8 py-7 `}
