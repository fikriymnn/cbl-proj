...
function ProsesPondMesinHistory() {
                    ...
                    <div className="grid grid-cols-12 border-b-8 border-[#D8EAFF] gap-2 items-center ">
                      ...
                      <div className="text-neutral-500 text-sm font-semibold flex flex-col col-span-2">
                        <label>
                          Awal :
                          {
                            data.inspeksi_pond_awal[0]
                              ?.inspeksi_pond_awal_point[0]?.inspektor?.nama
                          }
                        </label>
                        <label>
                          Periode :
                          {
                            data.inspeksi_pond_periode[0]
                              ?.inspeksi_pond_periode_point[0]?.inspektor?.nama
                          }
                        </label>
                      </div>
                      <label className="text-neutral-500 text-sm font-semibold col-span-2">
...
export default ProsesPondMesinHistory;
