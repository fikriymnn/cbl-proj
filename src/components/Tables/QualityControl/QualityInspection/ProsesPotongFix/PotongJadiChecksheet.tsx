                                                    ...
                                                    <label className='text-neutral-500 text-sm font-semibold col-span-2'>
                                                        <div>
                                                            <input
                                                                ...
                                                                type="radio" id="standart" name="standart" value="ART WORK" />
                                                        ...
                                                        <div>
                                                            <input
                                                                ...
                                                                type="radio" id="standart2" name="standart" value="CONTOH" />
                                                    ...
                                                    <div className='flex flex-col gap-1  w-[50%] col-span-2'>
                                                        <div>
                                                            <input
                                                                ...
                                                                type="radio" id="presisi11" name="presisi11" value="presisi" />
                                                        ...
                                                        <div>
                                                            <input
                                                                ...
                                                                type="radio" id="presisi12" name="presisi11" value="tidak presisi" />
                                                    ...
                                                    <div className='flex flex-col gap-1  w-[50%] col-span-2'>
                                                        <div>
                                                            <input
                                                                ...
                                                                type="radio" id="rata31" name="rata31" value="rata" />
                                                        ...
                                                        <div>
                                                            <input
                                                                ...
                                                                type="radio" id="rata32" name="rata31" value="tidak rata" />
                                                    ...
                                                    <div className='flex flex-col gap-1  w-[50%] col-span-2'>
                                                        ...
                                                        <div>
                                                            <input
                                                                ...
                                                                type="radio" id="ok2" name="ok1" value="not ok" />
