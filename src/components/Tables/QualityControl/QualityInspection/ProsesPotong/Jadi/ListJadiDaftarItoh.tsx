...
function ListJadiDaftarItoh() {
    ...
    async function getInspection() {
        const url = `${import.meta.env.VITE_API_LINK}/qc/cs/inspeksiPotong?status=incoming&jenis_potong=potong jadi&mesin=ITOH`;
        try {
                                ...
                                <>
                                    <section className=' grid grid-cols-10 px-4 items-center  border-b-8 border-[#D8EAFF] '>
                                        ...
                                        <div className='flex flex-col  justify-end col-span-4 items-end'>
                                            ...
                                            <Link to={`/qc/qualityinspection/potong/potongjadi/${data.id}`}>
...
export default ListJadiDaftarItoh