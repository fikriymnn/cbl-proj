...
function HistoryBahanDaftarPolar() {
    ...
    async function getInspection() {
        const url = `${import.meta.env.VITE_API_LINK}/qc/cs/inspeksiPotong?status=history&jenis_potong=potong bahan&mesin=POLAR`;
        try {
...
export default HistoryBahanDaftarPolar