            ...
            </div>
            {
                brandData.map((data, key) => (
                    <div className="rounded-xl border  border-stroke bg-white py-3 shadow-default dark:border-strokedark dark:bg-boxdark ">
                        ...
                        <div
                            className='grid grid-cols-12 dark:border-strokedark items-center px-4'
                        >
                            ...
                            <div className="flex w-full text-[14px] justify-start col-span-2">
                                <p className="text-neutral-500 text-sm font-light ">{data.percent}</p>
                            </div>
                            <div className="flex w-full text-[14px] justify-start ">
                                <p className="text-neutral-500 text-sm font-light ">{data.eksekutor}</p>
                            </div>
