...
function ListJOProduksi() {
  ...
  async function getKalkulasi(id: any, jo: any, i: any, is_lembur: boolean) {
                    ...
                    {data.status == 'calculated' ? (
                      ...
                      <>
                        <div className="flex flex-col gap-1">
                          <button
                            onClick={() => {
                              getKalkulasi(data.id, data.no_jo, i, false);
                            }}
                            className="text-[#0065de] text-sm   font-bold"
                          >
                            CALCULATE
                          ...
                          <button
                            onClick={() => {
                              getKalkulasi(data.id, data.no_jo, i, true);
                            }}
                            className="text-[#0065de] text-sm   font-bold"
                          >
                            LEMBUR
