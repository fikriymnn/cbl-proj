...
import BOMApproval from './BOMApproval';
import BOMApprovalFromIO from './BOMApprovalFromIO';
...
export default function TabApprovalBOM() {
      ...
      >
        <AppBar position="static" className="">
          <ThemeProvider theme={theme}>
            ...
            >
              <Tab label="BOM" {...a11yProps(0)} />
              <Tab label="BOM IO PROOF" {...a11yProps(1)} />
