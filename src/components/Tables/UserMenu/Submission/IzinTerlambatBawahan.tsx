...
function IzinTerlambatBawahan() {
  ...
  const [statusFilter, setStatusFilter] = useState<string>('request atasan');
  ...
  useEffect(() => {
    if (tanggal) {
      setTanggalMasuk((prev) => {
        const existingTime =
          prev && prev.includes('T') ? prev.split('T')[1] : '';
        return existingTime
          ? `${tanggal}T${existingTime}`
          : prev
          ? `${tanggal}T`
          : '';
      });
  ...
  async function getHistoryList() {
    ...
    try {
      ...
      console.log('History list response:', res.data);
  ...
  const handleResetFilter = () => {
    setStatusFilter('request atasan');
    setCurrentPage(1);
  };
      ...
      {showModal && selectedRequest && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4 text-white rounded-t-2xl">
            ...
            <div className="px-6 py-4 bg-gray-50 rounded-b-2xl flex justify-end">
              <button
                onClick={closeModal}
                className="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg transition-all duration-200"
              >
                Tutup
              </button>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="w-full rounded-lg border-2 border-gray-300 px-4 py-3 text-gray-800 font-medium focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-200"
                />
                {dateError && (
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className="min-h-[100px] w-full resize-none border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-800 font-medium focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-200"
          ...
          <div className="flex w-full justify-end items-center gap-4 px-8 py-6 bg-gray-50 border-t border-gray-200">
            <button
              ...
              className="flex px-8 py-3 justify-center items-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-gray-400 disabled:to-gray-500 shadow-lg hover:shadow-xl text-white font-bold rounded-lg transition-all duration-200 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
          ...
          <div className="px-8 py-4 bg-gray-50 border-b border-gray-200">
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <select
                ...
                className="px-4 py-2 border-2 border-gray-300 rounded-lg text-sm font-medium focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-200"
              >
                <option value="request atasan">Request Atasan</option>
                <option value="approved">Disetujui</option>
                <option value="rejected">Ditolak</option>
              </select>
              {statusFilter !== 'request atasan' && (
                <button
                  ...
                  >
                    ...
                    <div className="flex justify-center">
                      <button
                        ...
                        className="px-3 py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white text-xs font-bold rounded-lg transition-all duration-200 transform hover:scale-105 flex items-center gap-1"
                        title="Lihat detail"
                      >
                        <svg
                          className="w-4 h-4"
...
export default IzinTerlambatBawahan;
