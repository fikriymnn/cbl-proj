...
import ApprovalManagementIzinTerlambat from './ApprovalManagementIzinTerlambat';
...
export default function TabApprovalManagement() {
      ...
      >
        <AppBar position="static" className="">
          <ThemeProvider theme={theme}>
            ...
            >
              <Tab label="Approval Management" {...a11yProps(0)} />
        ...
        <TabPanel value={value} index={0} dir={theme.direction}>
          <ApprovalManagementIzinTerlambat />
        </TabPanel>
      </Box>
    </>
  );
