...
// It has no editable number inputs, no PPN/grand-total math, no tgl_kirim
// field, and no "Catatan Internal" field — those all live in
// EditPOModal.tsx. Reproduced as-is for completeness.
