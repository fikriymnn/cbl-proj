...
const ModalStockCheckPengganti = ({ children, isOpen, onClose, masalah1, machineName }:
    {
            ...
            <div className="w-full max-w-4xl bg-white rounded-xl shadow-md">
                ...
                <div className="px-4 pb-4">
                    ...
                    <div className="pt-3 border bg-blue-100 rounded border-stroke pb-4">
                        ...
                        <CheckStockPengganti no={2} spareName={"Adapter 3.5"} spareStatus={"Original"} spareStock={0} />
                        <CheckStockPengganti no={3} spareName={"INK Injector"} spareStatus={"Original"} spareStock={1} />
                        <CheckStockPengganti no={4} spareName={"VBL Sensor"} spareStatus={"Lokal"} spareStock={3} />

                    </div>
                    <div className="pt-4">
                        <button className="w-full h-12 text-center text-white text-xs font-bold bg-red-600 rounded-md">
                            PERMINTAAN PEMBELIAN STOCK BARU
                        </button>
                    </div>
                    <div className="pt-2">
...
export default ModalStockCheckPengganti;