...
const ModalEditSparepartMaster = ({ children, isOpen, onClose, idSparepart, data }:
    {
        children: any, isOpen: any, onClose: any, idSparepart: number, data: any
    ...
    const [sparepart, setSparepart] = useState(data);
    const [mesin, setMesin] = useState(data)
    const [umur, setUmur] = useState(data)
    ...
    const handleChangeSparepart = (e: any,) => {
        const { value } = e.target;
        const onchangeVal: any = sparepart;
        onchangeVal.nama_sparepart = value;
        setSparepart(onchangeVal);
    };
    const handleChangeMesin = (e: any,) => {
        const { value } = e.target;
        const onchangeVal: any = mesin;
        onchangeVal.nama_mesin = value;
        setMesin(onchangeVal);
    };
    const handleChangeUmur = (e: any,) => {
        const { value } = e.target;
        const onchangeVal: any = umur;
        onchangeVal.umur_a = value;
        setUmur(onchangeVal);
    };
    async function submitEDitMesin(id: number) {
        const url = `${import.meta.env.VITE_API_LINK}/master/sparepart/${id}`;
                    ...
                    <>
                        ...
                        <div className="flex w-full flex-row gap-4 pt-3 px-4">
                            ...
                            <div className="flex w-full">
                                <input
                                    name="nama_sparepart"
                                    defaultValue={sparepart.nama_sparepart}
                                    onChange={(e) => handleChangeSparepart(e)}
                                    type="text"
                        ...
                        <div className="flex w-full flex-row gap-4 pt-3 px-4">
                            ...
                            <div className="flex w-full">
                                <input
                                    name="nama_mesin"
                                    defaultValue={sparepart.nama_mesin}
                                    onChange={(e) => handleChangeMesin(e)}
                                    type="text"
                                    className=" w-[387px] h-10 border-2 border-stroke rounded-md"
                                />
                            </div>
                            ...
                            <div className="flex w-full">
                                <input
                                    name="umur_a"
                                    defaultValue={sparepart.umur_a}
                                    onChange={(e) => handleChangeUmur(e)}
                                    type="text"
                                    className=" w-[387px] h-10 border-2 border-stroke rounded-md"
                                />
                            </div>
                        ...
                        <div className="flex w-full px-6 py-3 justify-end">
                            <button
                                onClick={() => submitEDitMesin(idSparepart)}
...
export default ModalEditSparepartMaster;