...
const ModalPopupReq2 = ({ children, title, isOpen, onClose, ticketCode, machineName, incDate, machineCode, reqSchedule }:
    {
        children: any, title: any, isOpen: any, onClose: any,
        ticketCode: any, machineName: any, incDate: any, machineCode: any, reqSchedule: any
    }) => {
            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-md">
                ...
                <div className="px-4 pb-4">
                    ...
                    <div className="pt-3">
                        ...
                        <span id="incomingDate" className="text-amber-600 text-xl font-normal">
                            {reqSchedule}
                        </span>
                    </div>
