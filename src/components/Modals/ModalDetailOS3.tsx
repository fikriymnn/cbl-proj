      ...
      <div className="w-full max-w-4xl bg-white rounded-xl shadow-md max-h-screen overflow-y-auto">
        ...
        <div className="px-4 pb-4">
          ...
          <div>
            ...
            <div className="flex gap-5 bg-[#D8EAFF]">
              <div className=" flex flex-col gap-5 bg-[#E8F3FF] p-5">
                <p className=" text-sm font-semibold min-h-10 max-h-15">
                  Inspection Point
                </p>
                <p className=" text-sm font-semibold min-h-10 max-h-15">
                  Task List
          ...
          <div className="grid grid-cols-2">
            <div>
              <p className="text-sm font-extrabold text-black mt-5 mb-2">
                Lampiran gambar
              </p>
              <div className="bg-[#E7E7E7] w-50 h-50"></div>
            </div>
            <div>
              <div className="flex w-full pt-1">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="p-2 border text-left">Nama Sparepart Baru</th>
                  <th className="p-2 border text-left">Nama Sparepart Rusak</th>
              ...
              <tbody>
                {kebutuhanSparepart.map((item: any, index: any) => (
                  ...
                  >
                    ...
                    <td className="p-2 border">{item.grade_sparepart_baru}</td>
                    <td className="p-2 border">
                      {item.grade_sparepart_sebelumnya}
                    </td>
                    <td className="p-2 border">{item.lokasi_sparepart_baru}</td>
                    <td className="p-2 border">
