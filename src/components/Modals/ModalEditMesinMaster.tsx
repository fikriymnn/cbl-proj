...
const ModalEditMesinMaster = ({ children, isOpen, onClose, idMesin, data }:
    {
        children: any, isOpen: any, onClose: any, idMesin: number, data: any
    ...
    const [bagian, setBagian] = useState(data)
    const [lokasi, setLokasi] = useState(data)
    ...
    const handleChangeLokasi = (e: any,) => {
        const { value } = e.target;
        const onchangeVal: any = lokasi;
        onchangeVal.lokasi_mesin = value;
        setLokasi(onchangeVal);
    };
    const handleChangeBagian = (e: any,) => {
        const { value } = e.target;
        const onchangeVal: any = bagian;
        ...
        try {
            const res = await axios.put(
                url,
                {
                    ...
                    lokasi_mesin: Mesin.lokasi_mesin,
                    bagian_mesin: Mesin.bagian_mesin
                    ...
                    <>
                        ...
                        <div className="flex w-full flex-row gap-4 pt-3 px-4">
                            ...
                            <div className="flex w-full">
                                <input
                                    name="lokasi_mesin"
                                    defaultValue={Mesin.lokasi_mesin}
                                    onChange={(e) => handleChangeLokasi(e)}
                                    type="text"
                                    className=" w-[387px] h-10 border-2 border-stroke rounded-md"
                                />
                            </div>
                            ...
                            <div className="flex w-full">
                                <input
                                    name="bagian_mesin"
                                    defaultValue={Mesin.bagian_mesin}
                                    onChange={(e) => handleChangeBagian(e)}
                                    type="text"
                                    className=" w-[387px] h-10 border-2 border-stroke rounded-md"
                                />
                            </div>
                        ...
                        <div className="flex w-full px-6 py-3 justify-end">
                            <button
                                onClick={() => submitEDitMesin(idMesin)}
...
export default ModalEditMesinMaster;