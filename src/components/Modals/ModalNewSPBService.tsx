                    ...
                    return (
                      <>
                        <div className="z-50 pb-2 bg-blue-100 px-4 py-1">
                          ...
                          <div>
                            <div className="md:flex flex-row px-3 pb-2 gap-4 bg-blue-100 ">
                              <div className="">
                              ...
                              <div className=" md:w-[200px]  w-full">
                                <p className="font-semibold mb-1 md:mt-0 mt-3 text-sm">
                                  Nama Barang
                                </p>
                                <div className="">
                                  <button
                                    ...
                                    className="relative z-20 bg-white dark:bg-form-input rounded-md md:w-[200px] w-full h-12 shadow-sm text-start px-2"
                                  >
                                    {val.nama_sparepart == ''
                                      ? 'PILIH NAMA BARANG'
                                      : val.nama_sparepart}
                              ...
                              <div className=" md:w-[150px] w-full ">
                                ...
                                <input
                                  ...
                                  disabled
                                  name="kodepart"
                                  className="border-2  md:w-[150px] w-full  shadow-sm bg-gray-200 rounded-md border-stroke sm:block text-black  text-xs font-bold  lg:pl-4 py-3"
                                ></input>
                              </div>
                              <div className=" md:w-[150px] w-full ">
                                <p className="font-semibold mb-1 md:mt-0 mt-3 text-sm">
                                ...
                                <input
                                  ...
                                  disabled
                                  name="mesin"
                                  className=" md:w-[150px] w-full border-2 shadow-sm bg-gray-200 rounded-md border-stroke sm:block text-black  text-xs font-bold py-3 lg:pl-4"
                                ></input>
                              </div>
                              <div className=" md:w-[150px] w-full ">
                                <p className="font-semibold mb-1 md:mt-0 mt-3 text-sm">
                                ...
                                <input
                                  ...
                                  className=" md:w-[150px] w-full text-black p-3 shadow-sm rounded-md text-gray-800 text-base font-light"
                                ></input>
                              </div>
                              <div className="md:w-[200px]  w-full">
                                <p className="font-semibold mb-1 md:mt-0 mt-3 text-sm">
                                ...
                                <input
                                  ...
                                  type="date"
                                  onChange={(e) => handleChangeService(e, i)}
                                  className=" text-black p-3 w-full shadow-sm rounded-md text-gray-800 text-base font-light"
                                ></input>
                              </div>
                        ...
                        <div className="pb-2 bg-blue-100 px-4 py-1">
                          ...
                          <div>
                            <div className="md:flex flex-row px-3 pb-2 gap-4 bg-blue-100 ">
                              ...
                              <div className="md:w-[200px] w-full">
                                <p className="text-sm font-semibold mb-1 md:mt-0 mt-3">
                                  Nama Barang
                                </p>
                                <button
                                  type="button"
                                  onClick={openModalStokSparepart}
                                  className="relative  bg-white dark:bg-form-input rounded-md md:w-[200px] w-full h-12 shadow-sm text-start px-2"
                                >
                                  {val.nama_sparepart == ''
                                    ? 'PILIH NAMA BARANG'
                                    : val.nama_sparepart}
                              ...
                              <div className="md:w-[150px] w-full ">
                                ...
                                <input
                                  ...
                                  className=" text-black p-3 md:w-[150px] w-full  shadow-sm rounded-md text-gray-800 text-base font-light"
                                ></input>
                              </div>
                              <div className="md:w-[200px] w-full ">
                                <p className="text-sm font-semibold mb-1 md:mt-0 mt-3">
                                ...
                                <input
                                  ...
                                  className=" text-black p-3 md:w-[200px] w-full  shadow-sm rounded-md text-gray-800 text-base font-light"
                                ></input>
                              </div>
