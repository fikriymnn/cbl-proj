...
const ModalPM1Confirm = ({ children, isOpen, onClose, id }:
    { children: any, isOpen: any, onClose: any, id: any }) => {
        ...
        <div className="fixed z-50 inset-0 overflow-y-auto backdrop-blur-sm bg-white/10 p-4 md:p-8 flex justify-center items-center">
            <div className="max-w-md w-90 bg-white rounded-xl shadow-md">
                <div className="flex w-full items-center pt-4 px-3">
                    ...
                    <label className='flex w-10/12 text-blue-700 text-sm font-bold '>Konfirmasi</label>
                ...
                <div className="flex w-full flex-col px-4 pb-4 pt-4">
...
export default ModalPM1Confirm;