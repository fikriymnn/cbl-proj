        ...
        <div className="fixed z-50 inset-0 backdrop-blur-sm bg-white/10 p-4 md:p-8 flex justify-center items-center  ">
            <div className="w-full max-w-4xl  bg-white rounded-xl shadow-md h-[690px]">
                <div className="flex w-full items-center pt-4">
                    <svg
                        className='flex lg:w-1/12 w-2/12'
                        width="20"
                        height="19"
                        viewBox="0 0 20 19"
                        fill="none"
                    ...
                    <label className='flex lg:w-11/12 w-10/12 text-blue-700 text-sm font-bold'>Purchasing History</label>
                ...
                <div className="px-5 pb-4">
                    ...
                    <div className=" border border-black rounded-md overflow-y-scroll h-65">
                        ...
                        >
                            ...
                            <div className="flex items-center text-[14px] lg:w-3/12 w-5/12 justify-center p-2.5">
                                <p className="text-slate-600 font-semibold text-center dark:text-white">Vendor</p>
                            </div>
                            <div className="flex items-center text-[14px] lg:w-3/12 justify-start p-2.5">
                                <p className="hidden sm:block text-slate-600 font-semibold text-center dark:text-white">Last Purchase History</p>
                            </div>
                        </div>
                        <Purchasing
                            no={1}
                    ...
                    <div className=" border border-black rounded-md overflow-y-scroll h-45">
                        ...
                        >
                            ...
                            <div className="flex items-center lg:w-5/12 justify-center p-2.5 pr-12">
                                <p className="text-slate-600 text-[14px] font-semibold text-center dark:text-white ">Sparepart Name</p>
                            </div>
                            <div className="flex items-center text-[14px] lg:w-2/12 justify-center p-2.5">
                                <p className="text-slate-600 font-semibold text-center dark:text-white">Vendor</p>
                            </div>
