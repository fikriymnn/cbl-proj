...
const ModalMtcStockCheck2 = ({ children, machineName, machineCode, isOpen, onClose, }:
        ...
        <div className="fixed z-50 inset-0 backdrop-blur-sm bg-white/10 p-4 md:p-8 flex justify-center items-center  ">
            <div className="w-full max-w-4xl  bg-white rounded-xl shadow-md h-[620px]">
                <div className="flex w-full items-center pt-4">
                    ...
                    <label className='flex w-11/12 text-blue-700 text-sm font-bold '>Sparepart Stock Check</label>
                ...
                <div className="px-5 pb-4">
                    ...
                    <div className=" border border-black rounded-md overflow-y-scroll h-80">
                        ...
                        >
                            ...
                            <div className="flex items-center w-5/12 justify-center p-2.5 ml-2">
                                <p className="text-slate-600 text-[14px] font-semibold text-center dark:text-white ">Sparepart Name</p>
                            </div>
                            <div className="flex items-center text-[14px] w-4/12 justify-center p-2.5 ml-2">
                                <p className="text-slate-600 font-semibold text-center dark:text-white">Sparepart Stock</p>
                            </div>
                        </div>
                        <CheckStock2
                            no={1}
