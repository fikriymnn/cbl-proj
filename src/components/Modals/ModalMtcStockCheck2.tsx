      ...
      <div className="w-full max-w-4xl  bg-white rounded-xl shadow-md h-[620px]">
        ...
        <div className="px-5 pb-4">
          ...
          <div className=" border border-black rounded-md overflow-y-scroll h-80">
            ...
            <CheckStock2 no={1} spareName={'Cable'} stock={5} />
            <CheckStock2 no={2} spareName={'Adapter 3.5'} stock={0} />
            <CheckStock2 no={2} spareName={'Adapter 3.5'} stock={0} />
            <CheckStock2 no={3} spareName={'Adapter 3.5'} stock={0} />
            <CheckStock2 no={4} spareName={'Adapter 3.5'} stock={0} />
            <CheckStock2 no={5} spareName={'Adapter 3.5'} stock={0} />
            <CheckStock2 no={6} spareName={'Adapter 3.5'} stock={0} />
            <CheckStock2 no={7} spareName={'Adapter 3.5'} stock={0} />
          </div>
          <div className="flex gap-8 pt-5 ">{children}</div>
        </div>
      </div>
    </div>
  );
...
export default ModalMtcStockCheck2;
