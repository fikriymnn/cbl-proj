...
const ModalPopupMon = ({ children, title, isOpen, onClose, ticketCode, machineName, incDate, machineCode, mtcSchedule, status }:
    {
            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-md">
                ...
                <div className="px-4 pb-4">
                    ...
                    <div className="pt-3">
                        ...
                        <span id="incomingDate" className="text-blue-700 text-xl font-normall">
                            {mtcSchedule}
                        </span>
                    </div>
                    <div className="pt-3">
                        ...
                        <span id="incomingDate" className="w-full text-blue-700 text-xl font-normal">
                            {status}
                        </span>
                    </div>
                </div>
