...
const ModalPM26type = ({ children, isOpen, onClose, machineName }:
        ...
        <div className="fixed z-50 inset-0 overflow-y-auto backdrop-blur-sm bg-white/10 p-4 md:p-8 flex justify-center items-center">
            <div className="w-full max-w-sm bg-white rounded-xl shadow-md">
                <div className="flex w-full items-center pt-4 px-3">
                    ...
                    <label className='flex w-10/12 text-blue-700 text-sm font-bold '>Tipe Maintenance</label>
