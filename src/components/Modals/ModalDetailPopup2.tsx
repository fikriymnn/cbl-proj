...
const Modal2 = ({ children, title, isOpen, onClose, ticketCode, prepName, incDate }:
    { children: any, title: any, isOpen: any, onClose: any, ticketCode: any, prepName: any, incDate: any }) => {
