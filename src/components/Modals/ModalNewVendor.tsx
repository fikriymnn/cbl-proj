...
const ModalNewVendor = ({ children, isOpen, onClose, }:
    { isOpen: any, onClose: any, children: any }) => {
        ...
        <div className="fixed z-50 inset-0 backdrop-blur-sm bg-white/10 p-4 md:p-8 flex justify-center items-center  ">
            <div className="w-full max-w-4xl  bg-white rounded-xl shadow-md h-[620px]">
                <div className="flex w-full items-center pt-4">
                    ...
                    <label className='flex w-11/12 text-blue-700 text-sm font-bold '>Purchasing Request</label>
                ...
                <div className="px-5 pb-4">
                    ...
                    <div className="pt-10">
                        <label htmlFor="ticketCode" className="form-label block  text-black text-xs font-extrabold pb-3">
                            VENDOR NAME
                        </label>
                        <input type="text" className="pl-3 w-5/12 h-10 border border-strokedark">
