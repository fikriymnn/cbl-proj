                    ...
                    <div className="min-w-[700px]">
                                                ...
                                                {data.waktu_selesai != null && (
                                                    <>
                                                        ...
                                                        <div className="p-4 flex flex-col ">
                                                            ...
                                                            <br />
                                                            <div className="">
                                                                <input type="file" disabled name="" id="" className="w-60" />
                                                            </div>
                        ...
                        <section className=" border-b-8 border-[#D8EAFF] flex flex-col">
                            ...
                            <div className="flex w-full md:justify-end justify-start">
                                <button className="py-2 px-10 mx-5 mt-5 bg-primary text-white rounded-md mb-5">
                                    SUBMIT INSPECTION
                                </button>
                            </div>
                        </section>
