...
function Pm2Form() {
    ...
    const handleChangePoint = (e: any, i: number) => {
        ...
        onchangeVal.inspection_point_pm2s[i][name] = value;
        setPm2(onchangeVal);
    };

    const totalWaktuTask = pm2 != null && pm2.inspection_point_pm2s != null ?
                          ...
                          {"Category:"+" " + data.category }
                            ...
                            <section className=" border-b-8 border-[#D8EAFF] flex flex-col">
                                ...
                                <div className='flex flex-col px-4 py-4 md:text-[14px] text-[9px] font-semibold '>
                                    ...
                                    <p className='text-[17px]'>{'Waktu Mulai PM2 : ' + waktuMulaiPm2}</p>
                                    <p className='text-[17px]'>{'Waktu Selesai PM2 : ' + waktuSelesaiPm2}</p>
                                </div>
                          ...
                          {"Category:"+" " + data.category }
                                ...
                                <section className=" border-b-8 border-[#D8EAFF] flex flex-col">
                                    ...
                                    <div className='flex flex-col px-4 py-4 md:text-[14px] text-[9px] font-semibold '>
                                        ...
                                        <p className='text-[15px]'>{'Waktu Mulai PM2 : ' + waktuMulaiPm2}</p>
                                        <p className='text-[15px]'>{'Waktu Selesai PM2 : ' + waktuSelesaiPm2}</p>
                                    </div>
