              ...
              {tiket != null &&
                tiket.map((data: any, i: any) => {
                  ...
                  return (
                    <>
                      <div className="my-1">
                        <section className="flex  bg-white  rounded-lg px-3 py-2">
                          <div className="grid grid-cols-4 w-full gap-1  ">
                            <div className="flex gap-0.5 items-start  my-auto">
                              <div>
                                <div>
                                  <button
                                    title="button"
                                    ...
                                    onClick={() => handleClick(i)}
                                  >
                                    <img src={Burger} alt="" className="mx-2" />
                                  </button>
                                  {showTwoButtons[i] ? (
                                    <div className="absolute bg-white p-3 shadow-5 rounded-md">
                                      {' '}
                            ...
                            <div className="flex  justify-start items-start my-auto">
                              <p className="text-xs font-light">
                                {data.nama_mesin}
                              </p>
                            </div>
                            <div className="flex my-auto  justify-start items-start">
