...
import RekapWasteQC from '../../components/Tables/QualityControl/RekapQC/RekapWasteQC';
import TableOSReadOnly from '../../components/Tables/Maintenance/TableOSReadOnly';
...
export default function TabOSProduksi() {
