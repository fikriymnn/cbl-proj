...
import ChecksheetOutsourcingBarangJadi from "../../../components/Tables/QualityControl/QualityInspection/incomingOutsourcingBarangJadi/CheckSheetIncomingOutsourcing";
...
const OutsourcingBarangJadiAwal = () => {
    ...
    return (
        <DefaultLayout>
            ...
            <ChecksheetOutsourcingBarangJadi/>

        </DefaultLayout>
    );
};

export default OutsourcingBarangJadiAwal;