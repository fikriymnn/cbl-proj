...
import TabIncomingOutsourcingBarangJadi from "../../../components/Tables/QualityControl/QualityInspection/incomingOutsourcingBarangJadi/TabIncomingOutsourcingBarangJadi";
...
const IncomingOutsourcingBarangJadi = () => {

    return (
        <DefaultLayout>

            <p className='font-semibold md:text-[28px] text-[20px] text-primary mb-[18px]'>QC &gt; Inspeksi Quality  &gt; Incoming Outsourcing Barang Jadi

            </p>

            <TabIncomingOutsourcingBarangJadi/>

        </DefaultLayout>
    );
};

export default IncomingOutsourcingBarangJadi;
