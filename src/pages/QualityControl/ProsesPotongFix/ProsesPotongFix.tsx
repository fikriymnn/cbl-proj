...
import TabProsesPotong from "../../../components/Tables/QualityControl/QualityInspection/ProsesPotongFix/TabPotong";
import DefaultLayout from "../../../layout/DefaultLayout";



const ProsesPotongFIX = () => {
...
export default ProsesPotongFIX;
